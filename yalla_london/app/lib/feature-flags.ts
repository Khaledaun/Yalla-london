...
export const isFeatureEnabled = (feature: keyof FeatureFlags): boolean => {
  ...
  // Master toggle check for Phase 4B features
  if (feature !== 'PHASE4B_ENABLED' && feature.startsWith && 
      (feature.includes('TOPIC_') || feature.includes('AUTO_') || feature.includes('SEO_') || 
       feature.includes('ANALYTICS_') || feature.includes('CONTENT_') || feature.includes('DRAFT_') || 
       feature.includes('AUDIT_') || feature.includes('READABILITY_') || feature.includes('APPROVAL_') || 
       feature.includes('PIPELINE_'))) {
