...
export const hotelsLuxury: PhotoEntry[] = [
  {
    ...
    url: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=1920",
    thumbnail: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=400",
    alt_en: "Luxury hotel bedroom with elegant European decor",
    alt_ar: "غرفة فندقية فاخرة بديكور أوروبي أنيق",
    category: "hotels-luxury",
    tags: ["luxury", "hotel", "room", "european", "elegant"],
    source: "unsplash",
    license: "unsplash",
    width: 1920,
    height: 1280,
...
export function getPhotosByTags(tags: string[]): PhotoEntry[] {
  return allPhotos.filter((photo) => tags.some((tag) => photo.tags.includes(tag.toLowerCase())));
}
