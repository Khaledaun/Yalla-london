  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        <span className="font-sans text-xs font-bold tracking-[1px] uppercase text-white hidden sm:inline">
          {isAr ? 'عاجل' : 'LIVE'}
        </span>
          ...
          {doubled.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {(isBreaking || isUrgent) && (
                  <span className={cn(
                    'inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-bold uppercase tracking-wider shrink-0',
