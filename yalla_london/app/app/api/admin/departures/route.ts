...
const CRON_DEFS: CronDef[] = [
  ...
  { path: '/api/cron/photo-refresh',          schedule: '15 3 */3 * *',       label: 'Photo Refresh (3d)',        icon: '📸', type: 'cron', category: 'content',      description: 'Seeds seasonal + trending Unsplash photos for all sites. Adapts to month (Christmas, Ramadan, summer, football).',  feedsInto: 'MediaAsset' },
