...
const TESTIMONIALS = [
  {
    ...
    stars: 5,
    textEn:
      "Yalla London helped me find the best halal restaurants and family-friendly attractions. Their insider tips on the Harrods food hall saved us hours of searching.",
    textAr:
      "ساعدني يالا لندن في العثور على أفضل المطاعم الحلال والأماكن المناسبة للعائلات. نصائحهم عن قسم الطعام في هارودز وفرت علينا ساعات من البحث.",
  },
  {
    ...
    stars: 5,
    textEn:
      "I planned my entire 10-day London trip using their guides. The neighborhood breakdowns and hotel reviews were spot-on — exactly what I needed as a first-time visitor.",
    textAr:
      "خططت رحلتي إلى لندن لمدة 10 أيام باستخدام أدلتهم. تحليل الأحياء ومراجعات الفنادق كانت دقيقة — بالضبط ما احتجته كزائرة لأول مرة.",
  },
  {
    name: "Omar Bassam",
    initials: "OB",
    ...
    stars: 5,
    textEn:
      "The best Arabic resource for London travel. Their guide to Knightsbridge shopping and the seasonal events calendar made our family holiday unforgettable.",
    textAr:
      "أفضل مصدر عربي للسفر إلى لندن. دليلهم للتسوق في نايتسبريدج وتقويم الفعاليات الموسمية جعل إجازة عائلتنا لا تُنسى.",
  },
];
...
const heroContent = {
  en: {
    ...
    titleLine2: "Your Way",
    description:
      "Your definitive Arabic guide to the best of London — curated luxury experiences, halal dining, and insider secrets.",
    cta: "Start Exploring",
    ctaLink: "/blog",
  },
  ar: {
...
const featuredArticle = {
  en: {
    ...
    excerpt:
      "25+ vetted halal restaurants across Mayfair, Soho and Knightsbridge with honest pricing, certification notes and booking tips.",
...
const FALLBACK_EVENTS = {
  ...
  ar: [
    ...
    {
      id: "2",
      title: "ماراثون لندن 2026",
      venue: "غرينيتش إلى ذا مول",
      day: "26",
      month: "أبريل",
      price: "مجاني للمشاهدة",
      image: "https://images.unsplash.com/photo-1513593771513-7b58b6c4af38?w=400&q=80",
      url: "",
    },
    {
      id: "3",
      title: "معرض تشيلسي للزهور",
      venue: "مستشفى تشيلسي الملكي",
      day: "19",
      month: "مايو",
      price: "من £40",
      image: "https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=400&q=80",
...
const text = {
  en: {
    trending: "Trending",
    trendingItems: [
      "London Marathon 2026 entries open",
      "Ramadan in London guide — iftar spots",
      "Spring in London — best parks and walks",
    ],
  ...
  ar: {
    ...
    trendingItems: [
      "ماراثون لندن 2026 — التسجيل مفتوح",
      "رمضان في لندن — أماكن الإفطار",
      "الربيع في لندن — أفضل الحدائق والمشي",
    ],
  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <div className="flex items-center gap-3">
        ...
        <h2 className={`text-2xl md:text-3xl font-heading font-bold text-yl-charcoal ${isArabic ? "font-arabic" : ""}`}>
          {title}
        </h2>
      </div>
      <Link
        href={href}
        className="group flex items-center gap-1.5 font-mono text-xs font-semibold tracking-wider uppercase text-yl-red hover:text-yl-gold transition-colors duration-300 ease-yl"
      >
        {linkText}
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (Array.isArray(tmEvents) && tmEvents.length > 0) {
            ...
            setLiveEvents(
              tmEvents.map((e: Record<string, unknown>) => {
                ...
                return {
                  ...
                  price,
                  image:
                    (e.imageUrl as string) || "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=400&q=80",
                  url: (e.url as string) || "",
                };
              }),
            );
    ...
    <div className={`bg-yl-cream ${isRTL ? "font-arabic" : "font-body"}`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      >
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <ArrowRight
                    className={`w-5 h-5 text-yl-gray-300 group-hover:text-yl-gold transition-all duration-300 ${isRTL ? "rotate-180 mr-auto" : "ml-auto"} group-hover:translate-x-1`}
                  />
                </div>
              </Link>
            ))}
          ...
          <div className="max-w-7xl mx-auto flex items-center gap-6 overflow-x-auto">
            ...
            {t.trendingItems.map((item, i) => (
              <Link
                ...
                className="font-body text-sm text-yl-gray-500 whitespace-nowrap hover:text-yl-charcoal transition-colors duration-300 ease-yl cursor-pointer"
              >
                {item}
              </Link>
            ))}
        ...
        <section className="relative max-w-7xl mx-auto px-7 py-16">
          {/* Subtle watermark */}
          <div
            className="absolute -right-20 top-10 w-[250px] h-[250px] opacity-[0.03] rotate-[8deg] pointer-events-none bg-[url('/branding/yalla-london/brand-kit-v2/yalla-brand-kit/logos/yalla-watermark-500px.png')] bg-contain bg-no-repeat bg-center"
            aria-hidden="true"
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <Link href={`/blog/${effectiveFeatured.slug}`} className="lg:col-span-3 group">
              <article className="relative h-full min-h-[400px] rounded-[14px] overflow-hidden border border-white/5">
                <Image
                  src={effectiveFeatured.image}
                  alt={effectiveFeatured.title}
                  fill
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <h3
                    className={`text-2xl md:text-3xl font-heading font-bold text-yl-parchment mb-3 group-hover:text-yl-gold transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                  >
                    {effectiveFeatured.title}
                  </h3>
                  <p className="font-body text-sm text-yl-gray-400 mb-4 max-w-lg line-clamp-2">
                    {effectiveFeatured.excerpt}
                  </p>
                  <div className="flex items-center gap-4 font-mono text-xs tracking-wider uppercase text-yl-gray-500">
                    ...
                    <span className="flex items-center gap-1">
                      <Clock className="w-3 h-3" /> {effectiveFeatured.readTime}
                    </span>
                  </div>
                </div>
              </article>
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
                  ...
                  <BrandCardLight hoverable className="p-0">
                    <article className="flex gap-4 p-4">
                      ...
                      <div className="flex flex-col justify-center min-w-0">
                        <span className="font-mono text-xs font-semibold text-yl-red uppercase tracking-wider mb-1">
                          {article.category}
                        </span>
                        <h4
                          className={`text-sm font-heading font-bold text-yl-charcoal group-hover:text-yl-red transition-colors duration-300 ease-yl line-clamp-2 mb-1.5 ${isRTL ? "font-arabic" : ""}`}
                        >
                          {article.title}
                        </h4>
              ...
              <BrandCard hoverable={false} className="p-6 flex-1 min-h-[140px]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className={`font-heading text-sm font-bold text-yl-parchment ${isRTL ? "font-arabic" : ""}`}>
                    {t.newsletter}
                  </h3>
                </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {displayEvents.map((event) => {
                ...
                const ticketHref =
                  event.url || getPageAffiliateLink(event.title, "experience", "yalla-london", "homepage-events");
                return (
                  <div
                    key={event.id}
                    className="group bg-yl-cream rounded-[14px] overflow-hidden border border-yl-gray-200 hover:-translate-y-1 hover:border-yl-gold/30 hover:shadow-lg transition-all duration-400 ease-yl"
                  >
                    <div className="relative h-44">
                      <Image
                        ...
                        alt={event.title}
                        fill
                        className="object-cover group-hover:scale-105 transition-transform duration-300 ease-yl"
                        unoptimized={event.image.includes("ticketmaster") || event.image.includes("tmol")}
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-yl-charcoal/50 to-transparent" />
                      <div
                        className={`absolute top-4 ${isRTL ? "right-4" : "left-4"} bg-white rounded-xl px-3 py-2 text-center shadow-md`}
                      >
                        <div className="text-2xl font-heading font-bold text-yl-charcoal leading-none">{event.day}</div>
                        <div className="font-mono text-xs font-bold text-yl-red uppercase tracking-wider">
                          {event.month}
                        </div>
                      </div>
                      {liveEvents.length > 0 && (
                        <div className={`absolute top-4 ${isRTL ? "left-4" : "right-4"}`}>
                          <span className="bg-green-500 text-white text-xs font-mono font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                            Live
                          </span>
                        </div>
                      )}
                    ...
                    <div className="p-5">
                      <h3
                        className={`font-heading font-bold text-yl-charcoal mb-1.5 group-hover:text-yl-red transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                      >
                        {event.title}
                      </h3>
                      ...
                      <span className="block font-mono text-sm font-bold text-yl-charcoal tracking-wider mb-3">
                        {event.price}
                      </span>
                      {event.url ? (
                        <a
                          ...
                          className="inline-flex items-center justify-center font-mono tracking-wider uppercase rounded-lg transition-all duration-300 ease-yl bg-yl-red text-white hover:bg-[#a82924] hover:-translate-y-0.5 shadow-lg py-2 px-4 text-xs w-full justify-center"
                        >
                          {t.getTickets}
                        </a>
                      ) : (
                ...
                return (
                  <Link key={i} href="/information" className="group">
                    <BrandCardLight className="p-5 text-center h-full flex flex-col items-center justify-center gap-3">
                      ...
                      <h3
                        className={`text-sm font-heading font-bold text-yl-charcoal group-hover:text-yl-red transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                      >
                        {section.title}
                      </h3>
        ...
        <section className="relative bg-white py-16 overflow-hidden">
          <div
            className="absolute right-[-40px] top-[20%] w-[180px] h-[180px] opacity-[0.03] rotate-[20deg] pointer-events-none bg-[url('/branding/yalla-london/brand-kit-v2/yalla-brand-kit/logos/yalla-watermark-500px.png')] bg-contain bg-no-repeat bg-center"
            aria-hidden="true"
          />
          <div className="relative z-10 max-w-7xl mx-auto px-7">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {guides[locale].map((guide) => (
                <div
                  key={guide.id}
                  className="group bg-white rounded-[14px] overflow-hidden border border-yl-gray-200 shadow-sm hover:-translate-y-1 hover:border-yl-gold/30 hover:shadow-lg transition-all duration-400 ease-yl"
                >
                  <div className="relative h-52">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <h3 className={`text-lg font-heading font-bold text-white ${isRTL ? "font-arabic" : ""}`}>
                        {guide.title}
                      </h3>
                    </div>
                  </div>
        ...
        <section className="relative bg-white py-16 overflow-hidden">
          <div
            className="absolute -left-16 bottom-10 w-[220px] h-[220px] opacity-[0.04] rotate-[-10deg] pointer-events-none bg-[url('/branding/yalla-london/brand-kit-v2/yalla-brand-kit/logos/yalla-watermark-500px.png')] bg-contain bg-no-repeat bg-center"
            aria-hidden="true"
          />
          <div className="relative z-10 max-w-7xl mx-auto px-7">
            <SectionHeader
              title={t.topExperiences}
              href="/experiences"
              linkText={t.viewAll}
              icon={Star}
              isArabic={isRTL}
                  ...
                  <div key={exp.id}>
                    <Link href="/experiences" className="group">
                      <div className="relative aspect-[3/4] rounded-[14px] overflow-hidden mb-3 border border-white/5 hover:-translate-y-1 hover:shadow-lg transition-all duration-400 ease-yl">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                          <h3
                            className={`font-heading font-bold text-white text-sm group-hover:text-yl-gold transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                          >
                            {exp.title}
                          </h3>
                        </div>
                      ...
                      <div className="flex items-center justify-between px-1">
                        ...
                        <span className="font-mono text-xs font-semibold text-yl-red tracking-wider uppercase group-hover:underline">
                          {t.bookNow}
                        </span>
                      </div>
                    </Link>
                  ...
                  <div key={hotel.id} className="group">
                    <Link href="/hotels">
                      <BrandCardLight className="overflow-hidden">
                        ...
                        <div className="p-5">
                          <h3
                            className={`text-lg font-heading font-bold text-yl-charcoal mb-1 group-hover:text-yl-red transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                          >
                            {hotel.name}
                          </h3>
                          ...
                          <p className="font-mono text-xs font-medium text-yl-gold tracking-wider uppercase mb-4">
                            {hotel.category}
                          </p>
                          <div className="flex items-center justify-between pt-4 border-t border-yl-gray-200">
                            <span className="font-mono text-sm font-bold text-yl-charcoal tracking-wider">
                              {hotel.price}
                            </span>
        ...
        <section className="bg-yl-cream py-16">
          <div className="max-w-7xl mx-auto px-7">
            <div className="text-center mb-10">
              ...
              <h2
                className={`text-2xl md:text-3xl font-heading font-bold text-yl-charcoal mb-3 ${isRTL ? "font-arabic" : ""}`}
              >
                ...
                <BrandCardLight key={i} hoverable={false} className="p-6">
                  <div className="flex items-center gap-1 mb-3">
                    {[...Array(5)].map((_, s) => (
                      <Star
                        key={s}
                        className={`w-4 h-4 ${s < item.stars ? "text-yl-gold fill-yl-gold" : "text-yl-gray-300"}`}
                      />
                    ))}
                  </div>
                  <p className="font-body text-yl-charcoal text-sm leading-relaxed mb-4 italic">
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-yl-gray-200">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-xs text-yl-gray-500 tracking-wider">
