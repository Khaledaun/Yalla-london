  ...
  en: [
    {
      ...
      featured: true,
      description:
        "Walk through the actual sets used in all eight Harry Potter films, see authentic costumes and hand-crafted props, and discover the filmmaking secrets behind the magic. Step onto Platform 9¾, stroll down Diagon Alley, and try a mug of Butterbeer in the backlot cafe. The Digital Art department showcase reveals how creatures like Dobby were brought to life through motion capture and CGI.",
      insiderTip:
        "Book the first morning slot (9:00 AM) for the emptiest sets and best photo opportunities. The last entry is often discounted — check the website a week in advance.",
      gccFeatures: [
        "Halal snacks available at the backlot cafe",
        "Prayer room on request at the visitor centre",
        "Arabic audio guide included with entry",
        "Family-friendly with pushchair access throughout",
        "Private VIP group tours available for families",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "Upgrade to the fast-track ticket to skip the queue, which can exceed an hour during summer weekends. Sunset slots offer the most dramatic golden-hour photography.",
      gccFeatures: [
        "Private capsule bookings for families up to 15 guests",
        "Nearby halal restaurants on the South Bank",
        "Climate-controlled capsules comfortable in all weather",
        "Pushchair and wheelchair accessible",
        "Arabic information leaflets at the ticket desk",
      ],
    ...
    },
    {
      ...
      featured: true,
      description:
        "Explore over 1,000 years of royal history at this imposing UNESCO World Heritage fortress on the Thames. View the dazzling Crown Jewels collection — including the 530-carat Great Star of Africa diamond — meet the iconic Yeoman Warders (Beefeaters) who share gripping tales of royal intrigue, and walk the very grounds where Anne Boleyn and Sir Walter Raleigh were imprisoned. The White Tower houses a remarkable collection of royal armour dating back to Henry VIII.",
      insiderTip:
        "Arrive at opening time (9:00 AM) and head straight for the Crown Jewels — the queue builds to 90 minutes by midday. The free Yeoman Warder tours depart every 30 minutes from the main entrance.",
      gccFeatures: [
        "Arabic audio guide available at no extra charge",
        "Halal food options at the New Armouries Cafe",
        "Prayer facilities at nearby Tower Hill mosque (5-min walk)",
        "Family ticket discounts for 2 adults + 3 children",
        "Step-free access to most areas including Crown Jewels",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Glide along the Thames past the Houses of Parliament, the Shard, Tower Bridge, the Globe Theatre, and Canary Wharf while an entertaining live commentary brings each landmark to life. The open-air upper deck is perfect for photography, while the heated lower saloon keeps you comfortable year-round. This is one of the best-value ways to see London from an entirely different perspective — and a welcome break for tired feet after a day of walking.",
      insiderTip:
        "Sit on the right side (starboard) heading to Greenwich for the best views of Tower Bridge and the Tower of London. The hop-on hop-off river pass offers better value than a single journey if you plan to explore Greenwich.",
      gccFeatures: [
        "Covered heated saloon suitable for all weather and modest dress",
        "Halal-certified snacks sold onboard",
        "Private boat charter available for groups up to 12",
        "Family-friendly with no age restrictions",
        "Accessible boarding at Westminster Pier",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Step inside The King's official London residence during the exclusive annual summer opening (late July to September). Walk through nineteen lavishly decorated State Rooms, including the Throne Room with its pair of thrones used for the 2023 Coronation, the Picture Gallery housing masterpieces by Rembrandt and Vermeer, and the Grand Staircase with its gilded bronze balustrade. The multimedia guide adds fascinating behind-the-scenes stories about state banquets and royal receptions.",
      insiderTip:
        "Book the combined ticket that includes the Royal Mews and Queen's Gallery for the full royal experience. Tuesday and Wednesday mornings are the quietest visiting days.",
      gccFeatures: [
        "Multimedia guide available in Arabic",
        "Modest dress code naturally suits the formal palace environment",
        "Halal restaurants within a 10-minute walk in Victoria",
        "Private group tours can be arranged for families",
    ...
    },
    {
      ...
      featured: true,
      description:
        "Experience the world's longest-running musical in London's legendary West End theatre district. Andrew Lloyd Webber's spectacular tale of obsession, love, and music unfolds beneath the Paris Opera House with a jaw-dropping chandelier crash, stunning pyrotechnics, and a 230-piece costume collection. The intimate His Majesty's Theatre — a Grade II listed Edwardian gem — makes every seat feel close to the action. Over 145 million people worldwide have seen this show, and the London production remains the definitive version.",
      insiderTip:
        "Premium stalls (rows D-G centre) offer the best sightlines for the chandelier scene. Book midweek matinees for cheaper tickets and a less crowded theatre. The show has no interval drinks queue if you pre-order at the bar.",
      gccFeatures: [
        "No food or alcohol required — suitable for all guests",
        "Shows available six evenings plus matinees",
        "Private box seating for families seeking seclusion",
        "Theatre is a short walk from halal restaurants on Haymarket",
        "Subtitled performances available on select dates",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Discover over two million years of human history and culture entirely free of charge at one of the world's greatest museums. The collection spans eight million objects across 94 galleries. Highlights include the Rosetta Stone that unlocked Egyptian hieroglyphics, the Elgin Marbles from the Parthenon, and a world-class Egyptian mummies collection with over 100 mummies and coffins. The Islamic world gallery (Room 42) showcases exquisite calligraphy, ceramics, and scientific instruments from the golden age of Islamic civilisation.",
      insiderTip:
        "The free 45-minute Eye-opener tours are the best way to navigate the vast collection — ask at the information desk for the next departure. The Islamic gallery and Egyptian rooms are closest to the main entrance on the ground floor.",
      gccFeatures: [
        "Free admission — no booking required",
        "Exceptional Islamic art and civilisation gallery (Room 42)",
        "Arabic audio guide available for hire",
        "Prayer room available on request at the information desk",
        "Family trails and activity backpacks for children",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Indulge in a luxury afternoon tea on the 31st floor of The Shard — Western Europe's tallest building — with floor-to-ceiling windows revealing panoramic views stretching to the Surrey Hills. The menu features freshly baked scones with clotted cream, artisan finger sandwiches, and a rotating selection of hand-crafted pastries from the head patissier. Choose from over 20 premium loose-leaf teas including rare single-estate Darjeeling and delicate jasmine silver tips. The elegant setting and impeccable service make this a quintessential London luxury experience.",
      insiderTip:
        "Request a window table when booking — the south-facing seats have the most dramatic views toward Tower Bridge and the City. Afternoon tea sells out weeks in advance during summer, so book early.",
      gccFeatures: [
        "Non-alcoholic afternoon tea option available by default",
        "Halal dietary requirements accommodated with advance notice",
        "Private dining rooms for families and groups",
        "Elegant dress code naturally aligns with modest fashion",
        "Adjacent prayer facilities at London Bridge Mosque (3-min walk)",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Explore 300 acres of stunning botanical gardens, Victorian glasshouses, and an 18-metre-high treetop walkway at this UNESCO World Heritage Site in leafy Richmond. Kew is home to the world's largest collection of living plants — over 50,000 species — displayed across themed gardens from Japanese landscapes to Mediterranean terraces. The iconic Palm House, a masterpiece of Victorian engineering, transports you into a tropical rainforest. Children love the interactive play areas and the 200-metre-long Great Pagoda with panoramic views.",
      insiderTip:
        "Visit in spring (April-May) for the bluebell woods and cherry blossom walkway, or December for the magical after-dark Christmas light trail. The Orangery restaurant offers the best lunch on-site.",
      gccFeatures: [
        "Expansive outdoor spaces ideal for families with children",
        "Halal-friendly food options at the on-site cafes",
        "Peaceful and serene environment suitable for all visitors",
        "Flat terrain and wide paths for pushchairs and wheelchairs",
        "Modest dress comfortable in the garden setting",
      ],
    ...
    },
    {
      ...
      featured: false,
      description:
        "Discover the legendary Harrods Food Hall — a cathedral of gastronomy spanning over 25 departments across an entire floor — then explore luxury boutiques along Sloane Street with a knowledgeable local guide. The walking tour covers the hidden history of Knightsbridge, from its medieval origins to its transformation into London's most exclusive shopping district. You will pass Harvey Nichols, the Lanesborough Hotel, and the elegant garden squares that make this neighbourhood a favourite of Gulf visitors year after year.",
      insiderTip:
        "Visit Harrods on a weekday morning before 11 AM to avoid the worst crowds. The lower ground floor food halls are less busy than the ground floor and have better sampling opportunities.",
      gccFeatures: [
        "Harrods has a dedicated Arabic-speaking concierge service",
        "Extensive halal food counters in the Food Hall",
        "Knightsbridge is the heart of London's Arab community",
        "Prayer facilities at Harrods and nearby mosques",
        "Tax-free shopping available for GCC visitors",
      ],
  ...
  ar: [
    {
      ...
      featured: true,
      description:
        "امشِ عبر المواقع الحقيقية المستخدمة في أفلام هاري بوتر الثمانية، وشاهد الأزياء والدعائم المصنوعة يدويًا، واكتشف أسرار صناعة السحر السينمائي. قف على رصيف 9¾، وتجول في زقاق دياغون، وجرّب كأس بيرة الزبدة في مقهى الباحة الخلفية. يكشف قسم الفن الرقمي كيف تم إحياء شخصيات مثل دوبي باستخدام تقنيات التقاط الحركة.",
      insiderTip:
        "احجز أول موعد صباحي (9:00 صباحًا) للاستمتاع بالمواقع فارغة وأفضل فرص التصوير. آخر موعد دخول غالبًا ما يكون بسعر مخفض.",
      gccFeatures: [
        "وجبات خفيفة حلال متوفرة في مقهى الباحة",
        "غرفة صلاة متاحة عند الطلب في مركز الزوار",
        "دليل صوتي باللغة العربية مع تذكرة الدخول",
        "مناسب للعائلات مع إمكانية استخدام عربات الأطفال",
        "جولات خاصة VIP للمجموعات العائلية",
      ],
      bestFor: ["العائلات", "محبو هاري بوتر", "الأطفال 5-15 سنة"],
      website: "https://www.wbstudiotour.co.uk",
    },
    {
      id: "2",
      ...
      featured: true,
      description:
        "ارتفع 135 مترًا فوق المدينة في كبسولة زجاجية مكيفة الهواء لمشاهدة بيغ بن وقصر باكنغهام وكاتدرائية القديس بولس ونهر التايمز المتعرج بزاوية 360 درجة. تستغرق كل دورة حوالي 30 دقيقة، مما يتيح لك وقتًا كافيًا لالتقاط الصور. في الأيام الصافية تمتد الرؤية لأربعين كيلومترًا حتى قلعة وندسور.",
      insiderTip:
        "اختر تذكرة المسار السريع لتفادي الطابور الذي قد يتجاوز ساعة في عطلات الصيف. مواعيد الغروب توفر أجمل فرص التصوير.",
      gccFeatures: [
        "حجز كبسولة خاصة للعائلات حتى 15 شخصًا",
        "مطاعم حلال قريبة على الضفة الجنوبية",
        "كبسولات مكيفة مريحة في جميع الأحوال الجوية",
        "مهيأة لعربات الأطفال والكراسي المتحركة",
        "نشرات معلوماتية بالعربية عند شباك التذاكر",
      ],
      bestFor: ["الزوار لأول مرة", "الأزواج", "العائلات مع أطفال صغار"],
      website: "https://www.londoneye.com",
    },
    {
      id: "3",
      ...
      featured: true,
      description:
        "استكشف أكثر من 1000 عام من التاريخ الملكي في هذه القلعة المهيبة المدرجة ضمن مواقع اليونسكو للتراث العالمي على ضفاف التايمز. شاهد مجموعة جواهر التاج المبهرة — بما فيها ألماسة نجمة أفريقيا الكبرى بوزن 530 قيراطًا — والتقِ بحراس يومان (البيفيترز) الذين يروون قصصًا مثيرة عن المؤامرات الملكية. يضم البرج الأبيض مجموعة رائعة من الدروع الملكية.",
      insiderTip:
        "احضر عند الافتتاح (9:00 صباحًا) وتوجه مباشرة لجواهر التاج — الطابور يصل إلى 90 دقيقة بحلول الظهيرة. جولات حراس يومان المجانية تنطلق كل 30 دقيقة.",
      gccFeatures: [
        "دليل صوتي عربي متاح بدون رسوم إضافية",
        "خيارات طعام حلال في مقهى نيو أرموريز",
        "مسجد تاور هيل قريب (5 دقائق سيرًا)",
        "تذاكر عائلية مخفضة لبالغين و3 أطفال",
        "وصول بدون درج لمعظم المناطق بما فيها جواهر التاج",
      ],
      bestFor: ["عشاق التاريخ", "العائلات", "محبو الثقافة"],
      website: "https://www.hrp.org.uk/tower-of-london",
    },
    {
      id: "4",
      ...
      featured: false,
      description:
        "انزلق على طول نهر التايمز أمام مباني البرلمان وذا شارد ومسرح غلوب وجسر البرج وكناري وارف بينما يقدم المعلق شرحًا حيًا ممتعًا عن كل معلم. السطح العلوي المكشوف مثالي للتصوير، والصالون السفلي المدفأ يبقيك مرتاحًا طوال العام. هذه واحدة من أفضل الطرق لرؤية لندن من منظور مختلف تمامًا وراحة مستحقة بعد يوم طويل من المشي.",
      insiderTip:
        "اجلس على الجانب الأيمن عند التوجه لغرينتش لأفضل إطلالة على جسر البرج. تذكرة الركوب المتعدد توفر قيمة أفضل إذا كنت تخطط لاستكشاف غرينتش.",
      gccFeatures: [
        "صالون مغطى ومدفأ مناسب لجميع الأحوال والملابس المحتشمة",
        "وجبات خفيفة حلال معتمدة تُباع على متن القارب",
        "إمكانية استئجار قارب خاص لمجموعات حتى 12 شخصًا",
        "مناسب للعائلات بدون قيود عمرية",
        "صعود ميسّر في رصيف ويستمنستر",
      ],
      bestFor: ["العائلات", "المصورون", "الزوار لأول مرة"],
      website: "https://www.thamesclippers.com",
    },
    {
      id: "5",
      ...
      featured: false,
      description:
        "ادخل إلى مقر إقامة الملك الرسمي في لندن خلال الافتتاح الصيفي الحصري (أواخر يوليو حتى سبتمبر). تجول في تسعة عشر غرفة رسمية مزينة ببذخ، بما في ذلك قاعة العرش التي تضم العرشين المستخدمين في حفل التتويج 2023، ومعرض الصور الذي يحوي روائع رامبرانت وفيرمير، والسلم الكبير بدرابزينه البرونزي المذهب. يضيف الدليل الصوتي قصصًا مثيرة عن حفلات الاستقبال الملكية.",
      insiderTip:
        "احجز التذكرة المشتركة التي تشمل الإسطبلات الملكية ومعرض الملكة للتجربة الكاملة. صباحات الثلاثاء والأربعاء هي الأهدأ.",
      gccFeatures: [
        "دليل وسائط متعددة باللغة العربية",
        "أجواء القصر الرسمية تتناسب طبيعيًا مع اللباس المحتشم",
        "مطاعم حلال قريبة في فيكتوريا (10 دقائق سيرًا)",
        "إمكانية ترتيب جولات خاصة للعائلات",
        "غرف رسمية مكيفة الهواء",
      ],
      bestFor: ["محبو الثقافة", "المسافرون الباحثون عن الفخامة", "عشاق التاريخ الملكي"],
      website: "https://www.rct.uk/visit/buckingham-palace",
    },
    {
      id: "6",
      ...
      featured: true,
      description:
        "استمتع بأطول عرض موسيقي في العالم في حي ويست إند الأسطوري. تتكشف قصة أندرو لويد ويبر المذهلة عن الهوس والحب والموسيقى تحت دار أوبرا باريس مع سقوط الثريا المذهل والألعاب النارية المبهرة ومجموعة من 230 زيًا. مسرح صاحب الجلالة — تحفة إدواردية مدرجة — يجعل كل مقعد يبدو قريبًا من المسرح. شاهد أكثر من 145 مليون شخص حول العالم هذا العرض.",
      insiderTip:
        "مقاعد الصفوف D-G في الوسط توفر أفضل زاوية لمشهد الثريا. احجز عروض منتصف الأسبوع النهارية لأسعار أرخص. يمكنك طلب المشروبات مسبقًا من البار لتجنب طابور الاستراحة.",
      gccFeatures: [
        "لا يتطلب طعامًا أو كحولًا — مناسب لجميع الضيوف",
        "عروض متاحة ست أمسيات بالإضافة لعروض نهارية",
        "مقاعد في لوج خاص للعائلات الباحثة عن الخصوصية",
        "المسرح قريب من مطاعم حلال في شارع هايماركت",
        "عروض مع ترجمة نصية في تواريخ مختارة",
      ],
      bestFor: ["الأزواج", "عشاق المسرح", "المراهقون والبالغون"],
      website: "https://www.thephantomoftheopera.com/london",
    },
    {
      id: "7",
      ...
      featured: false,
      description:
        "اكتشف أكثر من مليوني عام من تاريخ البشرية والثقافة مجانًا في واحد من أعظم متاحف العالم. تضم المجموعة ثمانية ملايين قطعة موزعة على 94 قاعة. أبرز المعروضات: حجر رشيد الذي فك شفرة الهيروغليفية، ورخام إلجن من البارثينون، ومجموعة مومياوات مصرية تضم أكثر من 100 مومياء. قاعة العالم الإسلامي (القاعة 42) تعرض أروع الخط العربي والسيراميك والأدوات العلمية من العصر الذهبي للحضارة الإسلامية.",
      insiderTip:
        'جولات "فتح العيون" المجانية (45 دقيقة) هي أفضل طريقة لاستكشاف المجموعة الضخمة — اسأل عند مكتب المعلومات عن الموعد التالي. قاعة الفن الإسلامي والمعروضات المصرية هي الأقرب للمدخل الرئيسي.',
      gccFeatures: [
        "دخول مجاني — لا حاجة لحجز مسبق",
        "قاعة استثنائية للفن والحضارة الإسلامية (القاعة 42)",
        "دليل صوتي عربي متاح للإيجار",
        "غرفة صلاة متاحة عند الطلب في مكتب المعلومات",
        "مسارات عائلية وحقائب أنشطة للأطفال",
      ],
      bestFor: ["محبو الثقافة", "العائلات", "عشاق التاريخ"],
      website: "https://www.britishmuseum.org",
    },
    {
      id: "8",
      ...
      featured: false,
      description:
        "استمتع بشاي بعد الظهر الفاخر في الطابق 31 من ذا شارد — أطول مبنى في أوروبا الغربية — مع نوافذ ممتدة من الأرض للسقف تكشف إطلالات بانورامية تصل حتى تلال سوري. تتضمن القائمة سكونز طازجة مع كريمة الكلوتد، وساندويتشات الأصابع الحرفية، وتشكيلة متجددة من المعجنات المصنوعة يدويًا. اختر من أكثر من 20 نوعًا من الشاي الفاخر. الأجواء الراقية والخدمة المتميزة تجعل هذه تجربة لندنية فاخرة بامتياز.",
      insiderTip:
        "اطلب طاولة بجانب النافذة عند الحجز — المقاعد المواجهة للجنوب توفر أجمل إطلالة على جسر البرج. يُنفد شاي بعد الظهر قبل أسابيع في الصيف، فاحجز مبكرًا.",
      gccFeatures: [
        "خيار شاي بعد الظهر بدون كحول متاح بشكل افتراضي",
        "تلبية المتطلبات الغذائية الحلال بإشعار مسبق",
        "غرف طعام خاصة للعائلات والمجموعات",
        "قواعد اللباس الأنيق تتوافق طبيعيًا مع الأزياء المحتشمة",
        "مسجد لندن بريدج القريب (3 دقائق سيرًا)",
      ],
      bestFor: ["الأزواج", "المسافرون الباحثون عن الفخامة", "عشاق الطعام"],
      website: "https://www.the-shard.com/restaurants/aqua-shard",
    },
    {
      id: "9",
      ...
      featured: false,
      description:
        "استكشف 300 فدان من الحدائق النباتية المذهلة والبيوت الزجاجية الفيكتورية وممشى قمم الأشجار بارتفاع 18 مترًا في موقع التراث العالمي لليونسكو في ريتشموند الخضراء. كيو موطن لأكبر مجموعة نباتات حية في العالم — أكثر من 50,000 نوع — معروضة في حدائق مواضيعية من المناظر اليابانية إلى شرفات البحر المتوسط. بيت النخيل الشهير ينقلك إلى غابة استوائية ممطرة. يحب الأطفال مناطق اللعب التفاعلية والباغودا الكبيرة.",
      insiderTip:
        "زر في الربيع (أبريل-مايو) لأزهار الجريس وممشى أزهار الكرز، أو في ديسمبر لمسار أضواء عيد الميلاد الساحر. مطعم أورانجيري يقدم أفضل غداء في الحديقة.",
      gccFeatures: [
        "مساحات خارجية واسعة مثالية للعائلات مع أطفال",
        "خيارات طعام حلال في المقاهي الداخلية",
        "بيئة هادئة وسلمية مناسبة لجميع الزوار",
        "ممرات مسطحة وعريضة لعربات الأطفال والكراسي المتحركة",
        "اللباس المحتشم مريح في أجواء الحديقة",
      ],
      bestFor: ["العائلات", "محبو الطبيعة", "المصورون"],
      website: "https://www.kew.org",
    },
    {
      id: "10",
      ...
      featured: false,
      description:
        "اكتشف قاعة هارودز الأسطورية للطعام — كاتدرائية للذواقة تمتد على أكثر من 25 قسمًا في طابق كامل — ثم استكشف البوتيكات الفاخرة على طول شارع سلون مع مرشد محلي خبير. تغطي الجولة السيرية التاريخ الخفي لنايتسبريدج، من أصولها في القرون الوسطى إلى تحولها لأرقى حي تسوق في لندن. ستمر بهارفي نيكلز وفندق لانزبورو والساحات الأنيقة التي تجعل هذا الحي المفضل لزوار الخليج عامًا بعد عام.",
      insiderTip:
        "زر هارودز صباح يوم عمل قبل الساعة 11 لتفادي الازدحام. قاعات الطعام في الطابق السفلي أقل ازدحامًا وتوفر فرصًا أفضل للتذوق.",
      gccFeatures: [
        "هارودز لديه خدمة كونسيرج ناطقة بالعربية",
        "كاونترات طعام حلال واسعة في قاعة الطعام",
        "نايتسبريدج قلب المجتمع العربي في لندن",
        "مرافق صلاة في هارودز والمساجد القريبة",
        "تسوق معفى من الضرائب لزوار الخليج",
      ],
      bestFor: ["عشاق التسوق الفاخر", "محبو الطعام", "العائلات الخليجية"],
      website: "https://www.harrods.com",
    },
  ],
};
    ...
    <div className={`bg-yl-cream ${isRTL ? "font-arabic" : "font-body"}`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="relative pb-14 pt-28 bg-gradient-to-b from-yl-dark-navy to-yl-dark-navy-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-7 text-center">
          <Breadcrumbs
            items={[{ label: isRTL ? "الرئيسية" : "Home", href: "/" }, { label: isRTL ? "تجارب" : "Experiences" }]}
            className="justify-center mb-6 text-yl-gray-400"
          />
          <SectionLabel>{isRTL ? "أنشطة مميزة" : "Curated Activities"}</SectionLabel>
          <h1
            className={`text-4xl md:text-5xl font-heading font-bold text-yl-parchment mb-4 ${isRTL ? "font-arabic" : ""}`}
          >
            {t.title}
          </h1>
          ...
          <div className="max-w-xl mx-auto relative">
            <Search
              className={`absolute ${isRTL ? "right-4" : "left-4"} top-1/2 -translate-y-1/2 w-5 h-5 text-yl-gray-500`}
            />
            <input
              type="text"
      ...
      {/* Top affiliate hero — captures above-the-fold intent before users scroll past 12+ cards */}
      <div className="max-w-4xl mx-auto px-7">
        <TopCategoryCta variant="experience" locale={locale as "en" | "ar"} pageSlug="experiences" />
      </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-7">
          <h2
            className={`text-3xl font-heading font-bold text-yl-charcoal mb-6 ${isRTL ? "font-arabic text-right" : ""}`}
          >
          ...
          {filteredExperiences.map((exp) => (
            <BrandCardLight key={exp.id} className="overflow-hidden group">
              <div className="relative aspect-[4/3]">
                ...
                <div
                  className={`absolute top-3 ${isRTL ? "left-3" : "right-3"} bg-white/90 backdrop-blur rounded-full px-2.5 py-1 flex items-center gap-1`}
                >
                  <Star className="w-3 h-3 text-yl-gold fill-yl-gold" />
                  <span className="font-mono text-[11px] font-bold text-yl-charcoal tracking-wider">{exp.rating}</span>
                </div>
              </div>
              <div className="p-5">
                <span className="font-mono text-[11px] font-semibold text-yl-red uppercase tracking-wider">
                  {exp.category}
                </span>
                <h3
                  className={`font-heading font-bold text-yl-charcoal mt-1 mb-2 line-clamp-2 group-hover:text-yl-red transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                >
                  {exp.title}
                </h3>
                <p className="font-body text-sm text-yl-gray-500 mb-3 line-clamp-2 leading-relaxed">
                  {exp.description}
                </p>
                <div className="flex items-center gap-4 font-mono text-[11px] text-yl-gray-500 tracking-wider mb-4">
                  <span className="flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-yl-gold" /> {exp.location}
                  </span>
                  <span className="flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-yl-gold" /> {exp.duration}
                  </span>
                </div>
                <div className="flex items-center justify-between pt-4 border-t border-yl-gray-200">
                  <div>
                    {exp.price === 0 ? (
                      ...
                      <>
                        <span className="font-mono text-[11px] text-yl-gray-500 tracking-wider uppercase">
                          {t.from}{" "}
                        </span>
      ...
      <section className="py-12 bg-yl-cream">
        <div className="max-w-7xl mx-auto px-7">
          <h2
            className={`text-3xl font-heading font-bold text-yl-charcoal mb-8 text-center ${isRTL ? "font-arabic" : ""}`}
          >
            ...
            <BrandCardLight className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className={isRTL ? "text-right" : ""}>
                  <h3 className={`font-heading font-bold text-yl-charcoal mb-2 ${isRTL ? "font-arabic" : ""}`}>
                    {locale === "ar"
                      ? "مواقع غرف الصلاة بالقرب من المعالم"
                      : "Prayer Room Locations at Major Attractions"}
                  </h3>
                  <p className="font-body text-sm text-yl-gray-500 leading-relaxed">
                    {locale === "ar"
            ...
            {[
              {
                q:
                  locale === "ar"
                    ? "هل المعالم السياحية في لندن مناسبة للعائلات؟"
                    : "Are London attractions family-friendly?",
                a:
                  locale === "ar"
              ...
              },
              {
                q:
                  locale === "ar"
                    ? "هل يمكنني العثور على طعام حلال بالقرب من المعالم السياحية؟"
                    : "Can I find halal food near attractions?",
                a:
                  locale === "ar"
              ...
              },
              {
                q:
                  locale === "ar"
                    ? "ما هي التجارب التي تقدم أدلة صوتية باللغة العربية؟"
                    : "Which experiences offer Arabic audio guides?",
                a:
                  locale === "ar"
              ...
              <div key={index} className="border border-yl-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  <span className={`font-heading font-bold text-yl-charcoal ${isRTL ? "font-arabic" : ""}`}>
                    {faq.q}
                  </span>
                  {openFaqIndex === index ? (
                ...
                {openFaqIndex === index && (
                  <div
                    className={`px-5 pb-5 font-body text-sm text-yl-gray-600 leading-relaxed ${isRTL ? "text-right" : ""}`}
                  >
                    {faq.a}
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/hotels" className="group">
              <BrandCardLight className="p-6 text-center h-full transition-shadow duration-300 group-hover:shadow-lg">
                ...
                <h3
                  className={`font-heading font-bold text-yl-charcoal mb-2 group-hover:text-yl-red transition-colors ${isRTL ? "font-arabic" : ""}`}
                >
