...
const recommendations = [
  {
    ...
    bestFor: [
      "Gulf families seeking five-star luxury",
      "Couples celebrating special occasions",
      "Business travellers in Mayfair",
    ],
  },
  {
    id: "2",
    ...
    description_ar:
      "رحلة طهوية حائزة على نجمة ميشلان داخل منزل مايفير السريالي الذي صممه الفنان مارتن كريد. تقدم قاعة المحاضرات والمكتبة في الطابق الأول مأكولات فرنسية حديثة مبهرة تشمل فوا غرا ولحم واغيو وقوائم تذوق معقدة تتغير مع المواسم. في الأسفل، المعرض — غرفة الطعام الوردية لديفيد شريغلي بـ239 عملًا فنيًا أصليًا — أصبح أكثر مطاعم لندن تصويرًا. كبسولات البيض في الحمام تجربة بحد ذاتها. يضم سكيتش أيضًا البارلور للحلويات والغليد لشاي بعد الظهر وبار الشرق للكوكتيلات المسائية — كل غرفة عالم فني مختلف تمامًا.",
    ...
    bestFor: [
      "Couples seeking a unique dining experience",
      "Instagram-savvy travellers",
      "Fashion-conscious diners in Mayfair",
    ],
  },
  {
    id: "3",
    ...
    bestFor: [
      "Luxury shoppers and fashion lovers",
      "Families looking for a full-day destination",
      "Foodies exploring the Food Halls",
    ],
  },
  {
    id: "4",
    ...
    bestFor: [
      "Royalty-level travellers who value heritage",
      "Couples on a luxury London getaway",
      "Fashion enthusiasts near Bond Street",
    ],
  },
  {
    id: "5",
    ...
    bestFor: [
      "Serious food lovers and culinary adventurers",
      "Couples celebrating anniversaries",
      "Business dining in a Knightsbridge setting",
    ],
  },
  {
    id: "6",
    ...
    bestFor: [
      "Families with children who love heights",
      "First-time London visitors for orientation",
      "Photography enthusiasts and sunset chasers",
    ],
  },
  {
    id: "7",
    ...
    bestFor: [
      "Discerning travellers who prefer quiet luxury over flash",
      "Spa lovers seeking the Aman experience",
      "Repeat London visitors who have outgrown the big-name hotels",
    ],
  },
  {
    id: "8",
    ...
    bestFor: [
      "Sushi and seafood aficionados",
      "Social diners who enjoy a buzzy atmosphere",
      "Business entertaining in a see-and-be-seen setting",
    ],
  },
  {
    id: "9",
    ...
    bestFor: [
      "Families with children interested in royalty",
      "History and fashion enthusiasts",
      "Visitors combining culture with Kensington shopping",
    ],
  },
  {
    id: "10",
    ...
    bestFor: [
      "Families wanting a sky-high experience",
      "Couples seeking dramatic skyline views",
      "Business travellers near London Bridge",
    ],
  },
];
...
export default function RecommendationsPage({ serverLocale }: { serverLocale?: "en" | "ar" }) {
  ...
  const insiderTips = [
    {
      ...
      desc_ar:
        "كثير من مطاعم لندن الراقية لا تعلن عن خيارات حلال لكنها تلبي الطلبات عند السؤال. اتصل دائمًا مسبقًا للتأكد من توفر اللحوم الحلال، خاصة في مطاعم ميشلان. تطبيقات مثل HalalTrip وZabihah موثوقة لإيجاد المطاعم المعتمدة. خلال رمضان، تقدم عدة فنادق فاخرة قوائم إفطار وسحور خاصة — احجز مبكرًا لأنها تمتلئ بسرعة.",
    },
    {
      icon: Users,
      ...
      desc_ar:
        "تبقى نايتسبريدج ومايفير الخيارين الأفضل للعائلات الخليجية، مع سهولة الوصول سيرًا إلى هارودز وهايد بارك ومطاعم حلال في إدجوير رود. كنسينغتون تقدم بديلًا أهدأ مع أجنحة عائلية ممتازة. بايزواتر وماربل آرتش تضم أعلى تركيز للمحلات والمقاهي والبقالات الناطقة بالعربية — مثالية للإقامات الطويلة.",
    },
    {
      icon: CalendarCheck,
  ...
  return (
    <div className={`bg-yl-cream min-h-screen ${isRTL ? "font-arabic" : "font-body"}`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      {/* Top affiliate hero — recommendations mix hotels/experiences/dining, "all" variant routes to Expedia London */}
      <div className="max-w-4xl mx-auto px-7">
        <TopCategoryCta variant="all" locale={locale as "en" | "ar"} pageSlug="recommendations" />
      </div>
        ...
        <div className="max-w-4xl mx-auto px-7">
          ...
          <div className="space-y-4 text-base text-yl-gray-500 font-body leading-relaxed">
            {locale === "en" ? (
              <>
                <p>
                  Every recommendation on this page has been personally vetted by our editorial team, drawing on years
                  of experience guiding Arab and Gulf travellers through the best of London. We do not simply list
                  popular venues — we select places that consistently deliver exceptional experiences with genuine
                  cultural sensitivity, halal dining options, Arabic-speaking staff, and prayer-friendly arrangements.
                  Whether you are visiting London for the first time with your family or returning for a seasonal
                  getaway, these are the establishments that earn our trust.
                </p>
                <p>
                  Our hotel selections prioritise privacy, generous suite configurations for families, proximity to
                  major attractions, and a track record of welcoming Gulf guests. For restaurants, we focus on
                  Michelin-quality dining that either offers fully halal menus or clearly labelled halal choices
                  alongside outstanding service. Our attraction picks balance iconic London landmarks with lesser-known
                  gems that reward curiosity — from royal palaces to panoramic viewpoints that transform your
                  understanding of the city.
                </p>
                <p>
                  We update these recommendations quarterly, revisiting each venue to confirm standards have been
                  maintained. Seasonal promotions, Ramadan packages, and Eid offers are highlighted as they become
                  available. If you have visited any of these places and have feedback, we would love to hear from you —
                  your insights help us keep this guide honest and useful for every traveller in our community.
                </p>
              </>
            ) : (
              <>
                <p>
                  كل توصية في هذه الصفحة تم تقييمها شخصيًا من قبل فريقنا التحريري، بالاعتماد على سنوات من الخبرة في
                  إرشاد المسافرين العرب والخليجيين إلى أفضل ما تقدمه لندن. نحن لا نكتفي بسرد الأماكن الشائعة — بل نختار
                  المنشآت التي تقدم تجارب استثنائية باستمرار مع حساسية ثقافية حقيقية وخيارات طعام حلال وموظفين يتحدثون
                  العربية وترتيبات ملائمة للصلاة. سواء كنت تزور لندن لأول مرة مع عائلتك أو تعود لقضاء إجازة موسمية، فهذه
                  هي المنشآت التي تحظى بثقتنا.
                </p>
                <p>
                  تعطي اختياراتنا للفنادق الأولوية للخصوصية وتوفر أجنحة عائلية واسعة وقربها من المعالم الرئيسية وسجل
                  حافل في استقبال ضيوف الخليج. أما المطاعم فنركز على مطاعم بمستوى ميشلان تقدم قوائم حلال بالكامل أو
                  خيارات حلال واضحة إلى جانب خدمة متميزة. واختياراتنا للمعالم توازن بين معالم لندن الأيقونية والجواهر
                  الأقل شهرة التي تكافئ الفضول — من القصور الملكية إلى نقاط المشاهدة البانورامية التي تغير فهمك للمدينة.
                </p>
                <p>
                  نقوم بتحديث هذه التوصيات كل ثلاثة أشهر، ونعيد زيارة كل مكان للتأكد من الحفاظ على المعايير. يتم إبراز
                  العروض الموسمية وباقات رمضان وعروض العيد فور توفرها. إذا زرت أيًا من هذه الأماكن ولديك ملاحظات، يسعدنا
                  أن نسمع منك — رؤيتك تساعدنا في الحفاظ على هذا الدليل صادقًا ومفيدًا لكل مسافر في مجتمعنا.
                </p>
              </>
            )}
          </div>
            ...
            <BrandCardLight key={item.id} className="overflow-hidden group">
              <div className="relative aspect-video">
                ...
                <div className={`absolute top-4 ${isRTL ? "right-4" : "left-4"}`}>
                  <BrandTag color="neutral">{labels[item.type as keyof typeof labels]}</BrandTag>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {(locale === "en" ? item.features_en : item.features_ar).map((feature) => (
                    <span
                      key={feature}
                      className="px-2 py-1 bg-yl-cream font-mono text-[11px] tracking-wider uppercase text-yl-gray-500 rounded-full border border-yl-gray-200/50"
                    >
                      {feature}
                    </span>
                  ))}
                ...
                {"bestFor" in item && (item as Record<string, unknown>).bestFor && (
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {((item as Record<string, unknown>).bestFor as string[]).map((b) => (
                      <span
                        key={b}
                        className="px-2.5 py-1 bg-yl-red/5 text-yl-red font-mono text-[11px] tracking-wider rounded-full border border-yl-red/15"
                      >
                        {b}
                      </span>
                    ))}
                ...
                {(() => {
                  const affLink = getPageAffiliateLink(
                    item.name_en,
                    item.type as AffiliateCategory,
                    "yalla-london",
                    "recommendations",
                  );
          ...
          <div className="text-center py-16">
            <p className="text-xl text-yl-gray-500 font-body">
              {locale === "en"
                ...
                : "لم يتم العثور على توصيات تطابق بحثك."}
            </p>
          </div>
        )}
      </section>
