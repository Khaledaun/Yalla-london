          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-gray-400">
                ...
                <a href={`mailto:info@${(process.env.NEXT_PUBLIC_SITE_URL || 'zenitha.luxury').replace(/^https?:\/\/(www\.)?/, '')}`} className="hover:text-orange-500 transition-colors">
                  {`info@${(process.env.NEXT_PUBLIC_SITE_URL || 'zenitha.luxury').replace(/^https?:\/\/(www\.)?/, '')}`}
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400">
