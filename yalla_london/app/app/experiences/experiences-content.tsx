  ...
  ar: [
    {
      ...
      image: 'https://images.unsplash.com/photo-1551269901-5c5e14c25df7?w=600&q=80',
      featured: true,
      description: 'امشِ عبر المواقع الحقيقية المستخدمة في أفلام هاري بوتر الثمانية، وشاهد الأزياء والدعائم المصنوعة يدويًا، واكتشف أسرار صناعة السحر السينمائي. قف على رصيف 9¾، وتجول في زقاق دياغون، وجرّب كأس بيرة الزبدة في مقهى الباحة الخلفية. يكشف قسم الفن الرقمي كيف تم إحياء شخصيات مثل دوبي باستخدام تقنيات التقاط الحركة.',
      insiderTip: 'احجز أول موعد صباحي (9:00 صباحًا) للاستمتاع بالمواقع فارغة وأفضل فرص التصوير. آخر موعد دخول غالبًا ما يكون بسعر مخفض.',
      gccFeatures: ['وجبات خفيفة حلال متوفرة في مقهى الباحة', 'غرفة صلاة متاحة عند الطلب في مركز الزوار', 'دليل صوتي باللغة العربية مع تذكرة الدخول', 'مناسب للعائلات مع إمكانية استخدام عربات الأطفال', 'جولات خاصة VIP للمجموعات العائلية'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1520986606214-8b456906c813?w=600&q=80',
      featured: true,
      description: 'ارتفع 135 مترًا فوق المدينة في كبسولة زجاجية مكيفة الهواء لمشاهدة بيغ بن وقصر باكنغهام وكاتدرائية القديس بولس ونهر التايمز المتعرج بزاوية 360 درجة. تستغرق كل دورة حوالي 30 دقيقة، مما يتيح لك وقتًا كافيًا لالتقاط الصور. في الأيام الصافية تمتد الرؤية لأربعين كيلومترًا حتى قلعة وندسور.',
      insiderTip: 'اختر تذكرة المسار السريع لتفادي الطابور الذي قد يتجاوز ساعة في عطلات الصيف. مواعيد الغروب توفر أجمل فرص التصوير.',
      gccFeatures: ['حجز كبسولة خاصة للعائلات حتى 15 شخصًا', 'مطاعم حلال قريبة على الضفة الجنوبية', 'كبسولات مكيفة مريحة في جميع الأحوال الجوية', 'مهيأة لعربات الأطفال والكراسي المتحركة', 'نشرات معلوماتية بالعربية عند شباك التذاكر'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1529655683826-aba9b3e77383?w=600&q=80',
      featured: true,
      description: 'استكشف أكثر من 1000 عام من التاريخ الملكي في هذه القلعة المهيبة المدرجة ضمن مواقع اليونسكو للتراث العالمي على ضفاف التايمز. شاهد مجموعة جواهر التاج المبهرة — بما فيها ألماسة نجمة أفريقيا الكبرى بوزن 530 قيراطًا — والتقِ بحراس يومان (البيفيترز) الذين يروون قصصًا مثيرة عن المؤامرات الملكية. يضم البرج الأبيض مجموعة رائعة من الدروع الملكية.',
      insiderTip: 'احضر عند الافتتاح (9:00 صباحًا) وتوجه مباشرة لجواهر التاج — الطابور يصل إلى 90 دقيقة بحلول الظهيرة. جولات حراس يومان المجانية تنطلق كل 30 دقيقة.',
      gccFeatures: ['دليل صوتي عربي متاح بدون رسوم إضافية', 'خيارات طعام حلال في مقهى نيو أرموريز', 'مسجد تاور هيل قريب (5 دقائق سيرًا)', 'تذاكر عائلية مخفضة لبالغين و3 أطفال', 'وصول بدون درج لمعظم المناطق بما فيها جواهر التاج'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?w=600&q=80',
      featured: false,
      description: 'انزلق على طول نهر التايمز أمام مباني البرلمان وذا شارد ومسرح غلوب وجسر البرج وكناري وارف بينما يقدم المعلق شرحًا حيًا ممتعًا عن كل معلم. السطح العلوي المكشوف مثالي للتصوير، والصالون السفلي المدفأ يبقيك مرتاحًا طوال العام. هذه واحدة من أفضل الطرق لرؤية لندن من منظور مختلف تمامًا وراحة مستحقة بعد يوم طويل من المشي.',
      insiderTip: 'اجلس على الجانب الأيمن عند التوجه لغرينتش لأفضل إطلالة على جسر البرج. تذكرة الركوب المتعدد توفر قيمة أفضل إذا كنت تخطط لاستكشاف غرينتش.',
      gccFeatures: ['صالون مغطى ومدفأ مناسب لجميع الأحوال والملابس المحتشمة', 'وجبات خفيفة حلال معتمدة تُباع على متن القارب', 'إمكانية استئجار قارب خاص لمجموعات حتى 12 شخصًا', 'مناسب للعائلات بدون قيود عمرية', 'صعود ميسّر في رصيف ويستمنستر'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=600&q=80',
      featured: false,
      description: 'ادخل إلى مقر إقامة الملك الرسمي في لندن خلال الافتتاح الصيفي الحصري (أواخر يوليو حتى سبتمبر). تجول في تسعة عشر غرفة رسمية مزينة ببذخ، بما في ذلك قاعة العرش التي تضم العرشين المستخدمين في حفل التتويج 2023، ومعرض الصور الذي يحوي روائع رامبرانت وفيرمير، والسلم الكبير بدرابزينه البرونزي المذهب. يضيف الدليل الصوتي قصصًا مثيرة عن حفلات الاستقبال الملكية.',
      insiderTip: 'احجز التذكرة المشتركة التي تشمل الإسطبلات الملكية ومعرض الملكة للتجربة الكاملة. صباحات الثلاثاء والأربعاء هي الأهدأ.',
      gccFeatures: ['دليل وسائط متعددة باللغة العربية', 'أجواء القصر الرسمية تتناسب طبيعيًا مع اللباس المحتشم', 'مطاعم حلال قريبة في فيكتوريا (10 دقائق سيرًا)', 'إمكانية ترتيب جولات خاصة للعائلات', 'غرف رسمية مكيفة الهواء'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?w=600&q=80',
      featured: true,
      description: 'استمتع بأطول عرض موسيقي في العالم في حي ويست إند الأسطوري. تتكشف قصة أندرو لويد ويبر المذهلة عن الهوس والحب والموسيقى تحت دار أوبرا باريس مع سقوط الثريا المذهل والألعاب النارية المبهرة ومجموعة من 230 زيًا. مسرح صاحب الجلالة — تحفة إدواردية مدرجة — يجعل كل مقعد يبدو قريبًا من المسرح. شاهد أكثر من 145 مليون شخص حول العالم هذا العرض.',
      insiderTip: 'مقاعد الصفوف D-G في الوسط توفر أفضل زاوية لمشهد الثريا. احجز عروض منتصف الأسبوع النهارية لأسعار أرخص. يمكنك طلب المشروبات مسبقًا من البار لتجنب طابور الاستراحة.',
      gccFeatures: ['لا يتطلب طعامًا أو كحولًا — مناسب لجميع الضيوف', 'عروض متاحة ست أمسيات بالإضافة لعروض نهارية', 'مقاعد في لوج خاص للعائلات الباحثة عن الخصوصية', 'المسرح قريب من مطاعم حلال في شارع هايماركت', 'عروض مع ترجمة نصية في تواريخ مختارة'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1569587112025-0d460e81a126?w=600&q=80',
      featured: false,
      description: 'اكتشف أكثر من مليوني عام من تاريخ البشرية والثقافة مجانًا في واحد من أعظم متاحف العالم. تضم المجموعة ثمانية ملايين قطعة موزعة على 94 قاعة. أبرز المعروضات: حجر رشيد الذي فك شفرة الهيروغليفية، ورخام إلجن من البارثينون، ومجموعة مومياوات مصرية تضم أكثر من 100 مومياء. قاعة العالم الإسلامي (القاعة 42) تعرض أروع الخط العربي والسيراميك والأدوات العلمية من العصر الذهبي للحضارة الإسلامية.',
      insiderTip: 'جولات "فتح العيون" المجانية (45 دقيقة) هي أفضل طريقة لاستكشاف المجموعة الضخمة — اسأل عند مكتب المعلومات عن الموعد التالي. قاعة الفن الإسلامي والمعروضات المصرية هي الأقرب للمدخل الرئيسي.',
      gccFeatures: ['دخول مجاني — لا حاجة لحجز مسبق', 'قاعة استثنائية للفن والحضارة الإسلامية (القاعة 42)', 'دليل صوتي عربي متاح للإيجار', 'غرفة صلاة متاحة عند الطلب في مكتب المعلومات', 'مسارات عائلية وحقائب أنشطة للأطفال'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80',
      featured: false,
      description: 'استمتع بشاي بعد الظهر الفاخر في الطابق 31 من ذا شارد — أطول مبنى في أوروبا الغربية — مع نوافذ ممتدة من الأرض للسقف تكشف إطلالات بانورامية تصل حتى تلال سوري. تتضمن القائمة سكونز طازجة مع كريمة الكلوتد، وساندويتشات الأصابع الحرفية، وتشكيلة متجددة من المعجنات المصنوعة يدويًا. اختر من أكثر من 20 نوعًا من الشاي الفاخر. الأجواء الراقية والخدمة المتميزة تجعل هذه تجربة لندنية فاخرة بامتياز.',
      insiderTip: 'اطلب طاولة بجانب النافذة عند الحجز — المقاعد المواجهة للجنوب توفر أجمل إطلالة على جسر البرج. يُنفد شاي بعد الظهر قبل أسابيع في الصيف، فاحجز مبكرًا.',
      gccFeatures: ['خيار شاي بعد الظهر بدون كحول متاح بشكل افتراضي', 'تلبية المتطلبات الغذائية الحلال بإشعار مسبق', 'غرف طعام خاصة للعائلات والمجموعات', 'قواعد اللباس الأنيق تتوافق طبيعيًا مع الأزياء المحتشمة', 'مسجد لندن بريدج القريب (3 دقائق سيرًا)'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=600&q=80',
      featured: false,
      description: 'استكشف 300 فدان من الحدائق النباتية المذهلة والبيوت الزجاجية الفيكتورية وممشى قمم الأشجار بارتفاع 18 مترًا في موقع التراث العالمي لليونسكو في ريتشموند الخضراء. كيو موطن لأكبر مجموعة نباتات حية في العالم — أكثر من 50,000 نوع — معروضة في حدائق مواضيعية من المناظر اليابانية إلى شرفات البحر المتوسط. بيت النخيل الشهير ينقلك إلى غابة استوائية ممطرة. يحب الأطفال مناطق اللعب التفاعلية والباغودا الكبيرة.',
      insiderTip: 'زر في الربيع (أبريل-مايو) لأزهار الجريس وممشى أزهار الكرز، أو في ديسمبر لمسار أضواء عيد الميلاد الساحر. مطعم أورانجيري يقدم أفضل غداء في الحديقة.',
      gccFeatures: ['مساحات خارجية واسعة مثالية للعائلات مع أطفال', 'خيارات طعام حلال في المقاهي الداخلية', 'بيئة هادئة وسلمية مناسبة لجميع الزوار', 'ممرات مسطحة وعريضة لعربات الأطفال والكراسي المتحركة', 'اللباس المحتشم مريح في أجواء الحديقة'],
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1513467535987-fd81bc7d62f8?w=600&q=80',
      featured: false,
      description: 'اكتشف قاعة هارودز الأسطورية للطعام — كاتدرائية للذواقة تمتد على أكثر من 25 قسمًا في طابق كامل — ثم استكشف البوتيكات الفاخرة على طول شارع سلون مع مرشد محلي خبير. تغطي الجولة السيرية التاريخ الخفي لنايتسبريدج، من أصولها في القرون الوسطى إلى تحولها لأرقى حي تسوق في لندن. ستمر بهارفي نيكلز وفندق لانزبورو والساحات الأنيقة التي تجعل هذا الحي المفضل لزوار الخليج عامًا بعد عام.',
      insiderTip: 'زر هارودز صباح يوم عمل قبل الساعة 11 لتفادي الازدحام. قاعات الطعام في الطابق السفلي أقل ازدحامًا وتوفر فرصًا أفضل للتذوق.',
      gccFeatures: ['هارودز لديه خدمة كونسيرج ناطقة بالعربية', 'كاونترات طعام حلال واسعة في قاعة الطعام', 'نايتسبريدج قلب المجتمع العربي في لندن', 'مرافق صلاة في هارودز والمساجد القريبة', 'تسوق معفى من الضرائب لزوار الخليج'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {filteredExperiences.map((exp) => (
            <BrandCardLight key={exp.id} className="overflow-hidden group">
              ...
              <div className="p-5">
                <span className="font-mono text-[11px] font-semibold text-yl-red uppercase tracking-wider">{exp.category}</span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-yl-gray-200">
                  <div>
                    {exp.price === 0 ? (
                      ...
                      <>
                        <span className="font-mono text-[11px] text-yl-gray-500 tracking-wider uppercase">{t.from} </span>
