  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4">
        ...
        <Link href="/shop" className="text-[#C8322B] hover:underline flex items-center gap-2">
      ...
      <div className="pt-28 pb-16 max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gray-100">
            ...
            {product.featured && (
              <span className="absolute top-4 left-4 px-3 py-1 bg-[#C8322B] text-white text-sm font-semibold rounded-full">
                Featured
              </span>
            )}
          </div>
          ...
          {/* Product Info */}
          <div>
            <h1 className="text-3xl font-bold text-[#1C1917] mb-3">{name}</h1>
            ...
            {(product.features as string[]).length > 0 && (
              <div className="mb-6">
                <h3 className="font-semibold text-[#1C1917] mb-3">{isRTL ? 'ماذا يتضمن' : "What's Included"}</h3>
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="text-4xl font-bold text-[#1C1917]">{sym}{product.price.toFixed(2)}</span>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#C8322B] hover:bg-[#a82520] text-white font-bold text-lg rounded-xl transition-colors disabled:opacity-50 mb-4"
            >
              {checkingOut ? (
