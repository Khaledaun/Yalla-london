...
interface TrainingModule {
  ...
  title: string;
  description: string;
  category: 'onboarding' | 'content_management' | 'seo_tools' | 'automation' | 'analytics' | 'troubleshooting';
...
const DEFAULT_TRAINING_MODULES: TrainingModule[] = [
  {
    ...
    description: 'Introduction to the Yalla London admin dashboard and core navigation',
    category: 'onboarding',
    difficulty: 'beginner',
    ...
    steps: [
      {
        ...
        content: 'Welcome to the Yalla London content management platform. This guide will help you understand the main features and navigation.',
        type: 'text'
      },
      {
        step_id: 'navigation_tour',
        title: 'Dashboard Navigation',
        content: 'Let\'s explore the main navigation areas of the admin dashboard.',
        type: 'interactive',
        ...
        interactive_elements: [
          {
            ...
            tooltip_content: 'Main navigation menu - access all admin features here',
            action_required: 'hover'
          },
          {
            element_selector: '.admin-sidebar',
            highlight_type: 'background',
            tooltip_content: 'Sidebar contains quick actions and status information',
      ...
      },
      {
        ...
        content: 'Quick quiz to test your understanding of dashboard navigation.',
        type: 'quiz'
      }
    ],
    completion_criteria: {
  ...
  },
  {
    ...
    description: 'Learn how to use the automated content generation and management pipeline',
    ...
    steps: [
      {
        ...
        content: 'The automated content pipeline helps you generate, review, and publish content efficiently.',
        type: 'text'
      },
      {
        ...
        interactive_elements: [
          {
            ...
            tooltip_content: 'Click here to start generating new content topics',
            action_required: 'click'
          }
        ]
      },
    ...
    completion_criteria: {
      required_steps: ['pipeline_overview', 'topic_generation', 'content_review', 'seo_optimization'],
    ...
    steps: [
      {
        ...
        content: 'Learn about GA4 and Google Search Console integration features.',
        type: 'text'
      },
      {
        step_id: 'ga4_setup',
        title: 'GA4 Configuration',
        content: 'Configure Google Analytics 4 integration for content tracking.',
        type: 'hands_on',
...
export const GET = withAdminAuth(async (request: NextRequest) => {
  try {
    ...
    const moduleProgress = allModules.map(module => ({
      ...
      completion_percentage: Math.floor(Math.random() * 100), // Mock progress
    ...
    return NextResponse.json({
      ...
      categories: ['onboarding', 'content_management', 'seo_tools', 'automation', 'analytics', 'troubleshooting'],
      user_role: userRole,
      total_modules: allModules.length,
      recommended_modules: allModules
        .filter(m => m.difficulty === 'beginner' || m.category === 'onboarding')
        .map(m => m.module_id)
        .slice(0, 3)
    });
