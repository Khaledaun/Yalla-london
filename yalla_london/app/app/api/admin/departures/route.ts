...
const CRON_DEFS: CronDef[] = [
  ...
  { path: '/api/cron/image-pipeline',         schedule: '0 8 * * *',          label: 'Image Pipeline',            icon: '🖼️', type: 'cron', category: 'content',      description: 'Stocks media library from Unsplash and assigns featured images to articles.',  feedsInto: 'MediaAsset' },
