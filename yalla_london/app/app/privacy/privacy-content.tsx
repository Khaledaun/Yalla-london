...
function getSiteInfo(siteId?: string) {
  ...
  const serviceDesc = isYacht
    ? 'a bilingual (English/Arabic) luxury yacht charter brokerage platform covering the Mediterranean'
    : 'a bilingual (English/Arabic) luxury London travel guide'
  const serviceDescAr = isYacht
    ? 'منصة وساطة لتأجير اليخوت الفاخرة ثنائية اللغة (إنجليزي/عربي) تغطي البحر الأبيض المتوسط'
    : 'دليل سفر فاخر ثنائي اللغة (إنجليزي/عربي) للندن'
  return { domain, email, isYacht, name, nameAr, serviceDesc, serviceDescAr }
}

function getContent(siteId?: string) {
  const s = getSiteInfo(siteId)
  const yachtDataItems = s.isYacht ? [
    'Charter inquiry submissions: your name, email address, phone number, preferred charter dates, destination preferences, number of guests, budget range, yacht type preferences, dietary requirements (including halal catering), and any special requests or accessibility needs',
    'Guest manifest information: names and passport details of charter guests as required by maritime authorities for vessel check-in procedures',
  ] : []
  const yachtDataItemsAr = s.isYacht ? [
    'طلبات استفسار التأجير: اسمك وعنوان بريدك الإلكتروني ورقم هاتفك وتواريخ التأجير المفضلة وتفضيلات الوجهة وعدد الضيوف ونطاق الميزانية وتفضيلات نوع اليخت والمتطلبات الغذائية (بما في ذلك الطعام الحلال) وأي طلبات خاصة أو احتياجات وصول',
    'معلومات بيان الضيوف: أسماء وتفاصيل جوازات سفر ضيوف التأجير كما تتطلبه السلطات البحرية لإجراءات تسجيل الدخول إلى السفينة',
  ] : []
  const affiliatePartners = s.isYacht
    ? 'Boatbookings, Click&Boat, GetYourGuide, Booking.com, and select yacht charter and hotel booking platforms'
    : 'Booking.com, Expedia, HalalBooking, GetYourGuide, Viator, StubHub, Ticketmaster, Klook, Skyscanner, Blacklane, Allianz Travel Insurance, and select hotel/restaurant booking platforms'
  const affiliatePartnersAr = s.isYacht
    ? 'Boatbookings و Click&Boat و GetYourGuide و Booking.com ومنصات حجز اليخوت والفنادق المختارة'
    : 'Booking.com و Expedia و HalalBooking و GetYourGuide و Viator و StubHub و Ticketmaster و Klook و Skyscanner و Blacklane و Allianz Travel Insurance ومنصات حجز فنادق/مطاعم مختارة'

  return {
  en: {
    title: 'Privacy Policy',
    lastUpdated: 'Last updated',
    intro: `Zenitha.Luxury LLC, operating as ${s.name} ("we", "us", or "our"), is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, and share your personal information when you visit ${s.domain} (the "Website"). We operate as ${s.serviceDesc}, and this policy applies to all users regardless of language preference. Zenitha.Luxury LLC is the data controller for all personal information processed through this Website.`,
    ...
    dataCollectPersonalItems: [
      ...
      `Newsletter subscriptions: your email address when you sign up to receive ${s.name} updates and curated recommendations`,
      ...
      `Feedback and communications: any additional information you choose to share with us through email correspondence at ${s.email}`,
      ...yachtDataItems,
    ],
    ...
    cookiesThirdPartyItems: [
      `When you click an affiliate link on our Website (e.g. to ${affiliatePartners}), the affiliate partner's website may set its own cookies on your device. These cookies are governed by that partner's own privacy and cookie policies, not ours`,
    ...
    thirdPartyItems: [
      ...
      `Affiliate partners (${affiliatePartners}): we link to these partners within our content. When you click through, your interaction with their platform is governed by their own terms and privacy policies. We receive anonymised commission reports but no personal data about your purchases`,
    ],
    ...
    affiliateItems: [
      `${s.name} participates in affiliate programmes with booking partners including ${affiliatePartners}. When you click an affiliate link on our Website and make a purchase or booking, we may earn a commission`,
      ...
      `Commission revenue helps us sustain ${s.name} as a free resource, fund our editorial team's research, and continue producing high-quality bilingual content for our readers`,
    ],
    ...
    rightsItems: [
      ...
      `To exercise any of these rights, please contact us at ${s.email}. We will respond within 30 days. If you are unsatisfied with our response, you have the right to lodge a complaint with the Information Commissioner's Office (ICO) at ico.org.uk`,
    ],
    ...
    childrenItems: [
      `${s.name} is not directed at children under the age of 13. We do not knowingly collect personal information from children under 13`,
      `If you are a parent or guardian and believe your child has provided personal information to us (e.g. via the contact form or newsletter sign-up), please contact us at ${s.email} and we will promptly delete such information`,
  ...
  ar: {
    ...
    intro: `تلتزم شركة Zenitha.Luxury LLC، التي تعمل تحت اسم ${s.nameAr} ("نحن" أو "لنا" أو "خاصتنا")، بحماية خصوصيتك. توضح سياسة الخصوصية هذه كيف نجمع ونستخدم ونخزن ونشارك معلوماتك الشخصية عند زيارتك لموقع ${s.domain} ("الموقع"). نعمل ك${s.serviceDescAr}، وتنطبق هذه السياسة على جميع المستخدمين بغض النظر عن تفضيل اللغة. شركة Zenitha.Luxury LLC هي المتحكم في البيانات لجميع المعلومات الشخصية التي تتم معالجتها عبر هذا الموقع.`,
    ...
    dataCollectPersonalItems: [
      ...
      `الاشتراك في النشرة الإخبارية: عنوان بريدك الإلكتروني عند التسجيل لتلقي تحديثات ${s.nameAr} والتوصيات المختارة`,
      ...
      `الملاحظات والمراسلات: أي معلومات إضافية تختار مشاركتها معنا عبر المراسلات البريدية على ${s.email}`,
      ...yachtDataItemsAr,
    ],
    ...
    cookiesThirdPartyItems: [
      `عند النقر على رابط إحالة على موقعنا (مثل ${affiliatePartnersAr})، قد يضع موقع شريك الإحالة ملفات تعريف ارتباط خاصة به على جهازك. تخضع هذه الملفات لسياسات الخصوصية وملفات تعريف الارتباط الخاصة بذلك الشريك، وليس لسياستنا`,
    ...
    thirdPartyItems: [
      ...
      `شركاء الإحالة (${affiliatePartnersAr}): نضع روابط لهؤلاء الشركاء ضمن محتوانا. عند النقر للانتقال، يخضع تفاعلك مع منصتهم لشروطهم وسياسات الخصوصية الخاصة بهم. نتلقى تقارير عمولة مجهولة الهوية ولكن لا نتلقى بيانات شخصية عن مشترياتك`,
    ],
    ...
    affiliateItems: [
      `تشارك ${s.nameAr} في برامج إحالة مع شركاء الحجز بما في ذلك ${affiliatePartnersAr}. عندما تنقر على رابط إحالة على موقعنا وتجري عملية شراء أو حجز، قد نكسب عمولة`,
      ...
      `تساعدنا إيرادات العمولة في الحفاظ على ${s.nameAr} كمورد مجاني وتمويل أبحاث فريقنا التحريري والاستمرار في إنتاج محتوى ثنائي اللغة عالي الجودة لقرائنا`,
    ],
    ...
    rightsItems: [
      ...
      `لممارسة أي من هذه الحقوق، يرجى الاتصال بنا على ${s.email}. سنرد خلال 30 يوماً. إذا لم تكن راضياً عن ردنا، لديك الحق في تقديم شكوى لمكتب مفوض المعلومات (ICO) على ico.org.uk`,
    ],
    ...
    childrenItems: [
      `${s.nameAr} غير موجه للأطفال دون سن 13 عاماً. لا نجمع عن علم معلومات شخصية من الأطفال دون 13 عاماً`,
      `إذا كنت والداً أو وصياً وتعتقد أن طفلك قد قدم معلومات شخصية لنا (مثل عبر نموذج الاتصال أو الاشتراك في النشرة الإخبارية)، يرجى الاتصال بنا على ${s.email} وسنحذف هذه المعلومات على الفور`,
...
export default function PrivacyPolicy({ siteId }: { siteId?: string }) {
    ...
    <div className={`max-w-4xl mx-auto px-7 pt-28 pb-12 ${isRTL ? 'rtl' : 'ltr'}`}>
      ...
      <div className="space-y-6">
        ...
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.dataCollectTitle}</h2>
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold mb-2">{c.dataCollectPersonalTitle}</h3>
              <p className="text-yl-gray-500 mb-2">{c.dataCollectPersonalIntro}</p>
            ...
            <div>
              ...
              <p className="text-yl-gray-500 mb-2">{c.dataCollectAutoIntro}</p>
              <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.howWeUseTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.howWeUseIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        {/* Cookies & Tracking */}
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.cookiesTitle}</h2>
          <div className="space-y-6">
            <p className="text-yl-gray-500">{c.cookiesIntro}</p>
            <div>
        ...
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.thirdPartyTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.thirdPartyIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        {/* Data Retention */}
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.retentionTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.retentionIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        {/* Your Rights */}
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.rightsTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.rightsIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        {/* Data Security */}
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.securityTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.securityIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        {/* Children's Privacy */}
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.childrenTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.childrenIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.transfersTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.transfersIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
        ...
        <BrandCardLight className="p-6">
          <h2 className="text-xl font-heading font-bold text-yl-charcoal mb-4">{c.updatesTitle}</h2>
          <p className="text-yl-gray-500 mb-3">{c.updatesIntro}</p>
          <ul className="list-disc list-inside text-yl-gray-500 space-y-2">
