...
const content = {
  ...
  ar: {
    ...
    intro: `تؤمن شركة Zenitha.Luxury LLC، التي تعمل باسم ${(SITES[getDefaultSiteId()] as Record<string, string>)?.name_ar || 'يلا لندن'}، بالشفافية الكاملة. توضح هذه الصفحة كيف نحقق الإيرادات من خلال شراكات الإحالة وكيف يرتبط ذلك بالمحتوى الذي تقرأه على موقعنا.`,
    ...
    whatItems: [
      ...
      `روابط الإحالة هي مصدر إيراداتنا الرئيسي وتساعدنا في الحفاظ على ${(SITES[getDefaultSiteId()] as Record<string, string>)?.name_ar || 'يلا لندن'} مجانياً لجميع الزوار.`,
