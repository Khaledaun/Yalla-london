...
export const ZENITHA_EXECUTION_PLAN: DevPlan = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description: "Generate 20 long-form articles via content pipeline for zenitha-yachts-med: destination guides, charter planning tips, yacht type comparisons, packing lists, crew etiquette. Target 1500+ words each.",
      testType: "content-pipeline-verify",
      testable: true, status: "todo", readiness: 0,
      dueDate: "2026-05-15", startDate: "2026-05-01", category: "content",
      dependsOn: ["Z.0.2"],
