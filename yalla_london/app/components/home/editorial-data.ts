...
// TODO(tech-debt): Replace this static fallback with a server-side fetch of
// the 4 latest published BlogPosts. Hardcoded slugs caused 404s for months
// because slug schemes drifted (2025 → 2026) and the AR homepage shipped
// links to articles that never existed. Use /api/admin/content-matrix or
// a focused /api/home/featured endpoint that returns canonical slugs from
// the BlogPost table.
  ...
  en: [
    {
      ...
      excerpt: "Cherry blossoms, outdoor markets, and longer days.",
    ...
    },
    {
      ...
      excerpt: "A detailed comparison of London's two iconic department stores.",
    ...
    },
    {
      ...
      category: "Dining",
      title: "Best Afternoon Tea in London",
      excerpt: "From The Ritz to Sketch, the ultimate guide to London's tea culture.",
  ...
  ar: [
    {
      ...
      excerpt: "أزهار الكرز والأسواق المفتوحة وأيام أطول.",
      image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&q=80",
      date: "مارس 2026",
      readTime: "8 دقائق",
    },
    {
      ...
      excerpt: "مقارنة تفصيلية بين أشهر متجرين في لندن.",
      image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&q=80",
      date: "مارس 2026",
      readTime: "6 دقائق",
    },
    {
      ...
      slug: "best-halal-afternoon-tea-london-2025",
      category: "مطاعم",
      title: "أفضل شاي العصر في لندن",
      excerpt: "من الريتز إلى سكتش، الدليل الشامل لثقافة الشاي في لندن.",
      image: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=600&q=80",
      date: "أبريل 2026",
      readTime: "7 دقائق",
    },
...
export const GUIDES = {
  en: [
    {
      id: "1",
      title: "The Complete London Guide",
      price: "Free",
    ...
    {
      id: "3",
      title: "Family London: Kids Guide",
      price: "Free",
      image: "https://images.unsplash.com/photo-1520986606214-8b456906c813?w=500&q=80",
      badge: null,
    },
  ],
  ar: [
    ...
    {
      id: "2",
      title: "دليل الطعام الحلال في لندن",
      price: "مجاني",
      image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&q=80",
      badge: "جديد",
    },
    {
      id: "3",
      title: "لندن العائلية: دليل الأطفال",
      price: "مجاني",
      image: "https://images.unsplash.com/photo-1520986606214-8b456906c813?w=500&q=80",
      badge: null,
    },
...
export const TESTIMONIALS = [
  {
    ...
    en: {
      location: "Dubai, UAE",
      text: "Yalla London helped me find the best halal restaurants and family-friendly attractions. Their insider tips on the Harrods food hall saved us hours of searching.",
    },
    ar: {
      location: "دبي، الإمارات",
      text: "ساعدني يالا لندن في العثور على أفضل المطاعم الحلال والأماكن المناسبة للعائلات. نصائحهم عن قسم الطعام في هارودز وفرت علينا ساعات من البحث.",
    },
  },
  {
    ...
    en: {
      location: "Doha, Qatar",
      text: "I planned my entire 10-day London trip using their guides. The neighborhood breakdowns and hotel reviews were spot-on.",
    },
    ar: {
      location: "الدوحة، قطر",
      text: "خططت رحلتي إلى لندن لمدة 10 أيام باستخدام أدلتهم. تحليل الأحياء ومراجعات الفنادق كانت دقيقة.",
    },
  },
  {
    name: "Omar Bassam",
    ...
    en: {
      location: "Riyadh, KSA",
      text: "The best Arabic resource for London travel. Their guide to Knightsbridge shopping made our family holiday unforgettable.",
    },
    ar: {
      location: "الرياض، السعودية",
      text: "أفضل مصدر عربي للسفر إلى لندن. دليلهم للتسوق في نايتسبريدج جعل إجازة عائلتنا لا تُنسى.",
    },
  },
];
...
export const TEXT = {
  en: {
    ...
    trendingItems: [
      ...
      "Ramadan in London \u2014 iftar spots",
      "Spring in London \u2014 best parks",
    ],
