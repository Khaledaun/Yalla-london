          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-gray-400">
                ...
                <a href={`mailto:hello@${(process.env.NEXT_PUBLIC_SITE_URL || 'yalla-london.com').replace(/^https?:\/\/(www\.)?/, '')}`} className="hover:text-orange-500 transition-colors">
                  {`hello@${(process.env.NEXT_PUBLIC_SITE_URL || 'yalla-london.com').replace(/^https?:\/\/(www\.)?/, '')}`}
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400">
