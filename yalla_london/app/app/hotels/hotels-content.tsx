  ...
  en: [
    {
      ...
      insiderTip:
        "Request a Park Suite on the 7th floor for the best unobstructed Hyde Park views. The Dorchester also offers a private VIP entrance on Deanery Street for guests who prefer discretion.",
      gccFeatures: [
        "Arabic-speaking concierge team",
        "Halal room service available 24/7",
        "Prayer mats and qibla direction provided on request",
        "Family interconnecting suites with separate living areas",
        "5-minute walk to London Central Mosque via Hyde Park",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "Book the Palm Court afternoon tea at least 8 weeks in advance for weekend sittings. Ask for a table near the central fountain for the most photogenic spot. The Ritz also offers a private dining room for families who prefer seclusion.",
      gccFeatures: [
        "Dedicated Arabic-speaking guest relations team",
        "Halal-certified afternoon tea options available on request",
        "Walking distance to Jermyn Street and Bond Street luxury shopping",
        "Spacious family suites with separate children's sleeping areas",
        "In-room dining with halal meat options",
      ],
    ...
    },
    {
      ...
      reviews: 2187,
      price: 580,
      image: "https://images.unsplash.com/photo-1590490360182-c33d5be3d53b?w=600&q=80",
      badge: "Art Deco Icon",
      description:
      ...
      insiderTip:
        "The Grand Piano Suite on the 6th floor has its own baby grand piano and a terrace overlooking Mayfair rooftops. Claridge's butler service is among the most discreet in London — they will unpack and press your wardrobe on arrival.",
      gccFeatures: [
        "Long history of hosting Gulf royal families",
        "Arabic-speaking staff across front desk and concierge",
        "Halal room service menu curated for Gulf guests",
        "Adjacent to Mount Street and Bond Street luxury boutiques",
        "Private dining rooms for family celebrations",
      ],
    ...
    },
    {
      ...
      reviews: 3876,
      price: 520,
      image: "https://images.unsplash.com/photo-1606402179428-a57976d71fa4?w=600&q=80",
      ...
      insiderTip:
        "Request a river-view room on floors 5-7 for the best Thames panoramas. The Savoy is the only hotel in London where traffic drives on the right — the forecourt entrance is uniquely designed for arriving guests.",
      gccFeatures: [
        "Halal options available through in-room dining",
        "Walking distance to the West End for family entertainment",
        "Connecting rooms and suites suitable for larger families",
        "Concierge experienced with Gulf visitor requirements",
        "Close to Savoy Mosque and Islamic Centre at Regent's Park",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "The Langham's Sterling Suite is one of London's largest at 5,000 square feet. For a quieter experience, visit the Chuan Spa during weekday mornings when it is nearly empty. The hotel is also just a 10-minute walk to London Central Mosque.",
      gccFeatures: [
        "10-minute walk to London Central Mosque in Regent's Park",
        "Halal-friendly dining options at Roux at The Landau",
        "Spacious family rooms with Marylebone Village shopping nearby",
        "Arabic satellite TV channels available in all rooms",
        "Concierge team familiar with arranging halal catering for events",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "The Conservatory Suite has a private glass-walled terrace overlooking Hyde Park — one of the most coveted balcony views in London. Ask the concierge about the hotel's private guided tours of nearby galleries, tailored for families.",
      gccFeatures: [
        "Dedicated Kids For All Seasons programme with supervised activities",
        "Halal room service and dietary accommodation at Amaranto",
        "Arabic-speaking staff and guest relations",
        "Direct Hyde Park access for family walks and cycling",
        "Prayer mats and qibla cards provided on request",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "The Hamilton Penthouse is a 5,000-square-foot duplex with a private roof terrace and views of every major London landmark. The ESPA Life spa offers a Hammam-style experience that is especially popular with Gulf guests.",
      gccFeatures: [
        "Hammam-inspired treatments at ESPA Life spa",
        "Arabic-speaking reception and concierge staff",
        "Family suites with kitchenettes for longer stays",
        "Halal dining arrangements through in-room dining",
        "Central Westminster location near Harrods by taxi in 10 minutes",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "The Connaught's butler service is the most personalised in London — your butler will remember your preferences from previous stays. Request the Apartment Suite for a separate living room and study, ideal for extended stays.",
      gccFeatures: [
        "Ultra-private atmosphere favoured by Gulf dignitaries",
        "Aman Spa with serene treatment philosophy",
        "Halal room service and bespoke dietary arrangements",
        "Butler service that recalls guest preferences across visits",
        "Steps from Mount Street's designer boutiques and art galleries",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "Request a west-facing room above floor 40 for sunset views over the entire City and West End skyline. The infinity pool is quietest before 8am — arrive early for a near-private swim above the clouds.",
      gccFeatures: [
        "Shangri-La's Asian hospitality tradition with cultural sensitivity",
        "Halal options available at TING restaurant and room service",
        "Prayer mats provided on request with qibla direction",
        "Borough Market nearby for diverse halal street food",
        "Family rooms with panoramic views and rollaway beds available",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "The Bulgari Suite has a wraparound terrace with views of Hyde Park and Knightsbridge. Book a private screening in the cinema for your family — they can arrange any film you request, including Arabic-language titles.",
      gccFeatures: [
        "Steps from Harrods, Harvey Nichols, and Sloane Street luxury shopping",
        "Halal room service and bespoke dietary menus",
        "Private cinema with Arabic film screenings on request",
        "Arabic-speaking concierge and guest services",
        "Family suites with Knightsbridge's best shopping at the doorstep",
      ],
  ...
  ar: [
    {
      ...
      insiderTip:
        "اطلب جناح بارك في الطابق السابع لأفضل إطلالة على هايد بارك. يوفر الفندق أيضاً مدخلاً خاصاً على شارع دينيري للضيوف الذين يفضلون الخصوصية.",
      gccFeatures: [
        "فريق كونسيرج يتحدث العربية",
        "خدمة غرف حلال متاحة على مدار الساعة",
        "سجادات صلاة واتجاه القبلة عند الطلب",
        "أجنحة عائلية متصلة بغرف معيشة منفصلة",
        "5 دقائق سيراً إلى مسجد لندن المركزي عبر هايد بارك",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "احجز شاي بالم كورت قبل 8 أسابيع على الأقل لجلسات نهاية الأسبوع. اطلب طاولة بالقرب من النافورة المركزية للحصول على أفضل صورة. يقدم الفندق غرفة طعام خاصة للعائلات.",
      gccFeatures: [
        "فريق علاقات ضيوف يتحدث العربية",
        "خيارات شاي بعد الظهر حلال متاحة عند الطلب",
        "قرب من التسوق الفاخر في شارع بوند وجيرمين",
        "أجنحة عائلية واسعة مع مناطق نوم منفصلة للأطفال",
        "خدمة طعام في الغرفة مع خيارات لحوم حلال",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "جناح البيانو الكبير في الطابق السادس يحتوي على بيانو خاص وشرفة تطل على أسطح مايفير. خدمة الخادم الشخصي من أكثر الخدمات تميزاً في لندن — سيقوم بتفريغ حقائبك وكي ملابسك عند الوصول.",
      gccFeatures: [
        "تاريخ طويل في استضافة العائلات الملكية الخليجية",
        "موظفون يتحدثون العربية في الاستقبال والكونسيرج",
        "قائمة طعام حلال في خدمة الغرف مصممة لضيوف الخليج",
        "مجاور لبوتيكات ماونت ستريت وبوند ستريت الفاخرة",
        "غرف طعام خاصة للاحتفالات العائلية",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "اطلب غرفة تطل على النهر في الطوابق 5-7 لأفضل إطلالات على التايمز. سافوي هو الفندق الوحيد في لندن حيث تسير السيارات على اليمين — الساحة الأمامية مصممة بشكل فريد.",
      gccFeatures: [
        "خيارات حلال متاحة من خلال خدمة الغرف",
        "قرب من الويست إند للترفيه العائلي",
        "غرف متصلة وأجنحة مناسبة للعائلات الكبيرة",
        "كونسيرج ذو خبرة في متطلبات الزوار الخليجيين",
        "قريب من مسجد ريجنتس بارك المركزي",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "جناح ستيرلينغ هو واحد من أكبر الأجنحة في لندن بمساحة 5,000 قدم مربع. لتجربة أكثر هدوءاً زر سبا شوان صباح أيام الأسبوع. الفندق على بعد 10 دقائق سيراً من مسجد لندن المركزي.",
      gccFeatures: [
        "10 دقائق سيراً إلى مسجد لندن المركزي في ريجنتس بارك",
        "خيارات طعام حلال في مطعم رو في ذا لانداو",
        "غرف عائلية واسعة مع تسوق قرية ماريليبون القريبة",
        "قنوات تلفزيونية عربية عبر الأقمار الصناعية في جميع الغرف",
        "فريق كونسيرج يرتب تقديم طعام حلال للمناسبات",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "جناح الكونسيرفاتوري يحتوي على شرفة زجاجية خاصة تطل على هايد بارك — من أكثر الإطلالات المرغوبة في لندن. اسأل الكونسيرج عن الجولات الخاصة بالمعارض القريبة المصممة للعائلات.",
      gccFeatures: [
        "برنامج كيدز فور أول سيزونز مع أنشطة مشرفة للأطفال",
        "خدمة غرف حلال وتلبية الاحتياجات الغذائية في أمارانتو",
        "موظفون يتحدثون العربية",
        "وصول مباشر إلى هايد بارك للمشي العائلي",
        "سجادات صلاة وبطاقات قبلة عند الطلب",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "بنتهاوس هاميلتون هو دوبلكس بمساحة 5,000 قدم مربع مع شرفة خاصة على السطح. يقدم سبا ESPA Life تجربة حمام مستوحاة من الحمام التقليدي وهي محبوبة جداً لدى ضيوف الخليج.",
      gccFeatures: [
        "علاجات مستوحاة من الحمام في سبا ESPA Life",
        "موظفو استقبال وكونسيرج يتحدثون العربية",
        "أجنحة عائلية مع مطابخ صغيرة للإقامات الطويلة",
        "ترتيبات طعام حلال من خلال خدمة الغرف",
        "موقع مركزي في ويستمنستر مع وصول سريع لهارودز بالتاكسي",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "خدمة الخادم الشخصي في كونوت هي الأكثر تخصيصاً في لندن — سيتذكر خادمك الشخصي تفضيلاتك من الإقامات السابقة. اطلب جناح الشقة لغرفة معيشة ومكتب منفصلين.",
      gccFeatures: [
        "أجواء خصوصية فائقة يفضلها كبار الشخصيات الخليجية",
        "سبا آمان بفلسفة علاجية هادئة",
        "خدمة غرف حلال وترتيبات غذائية مخصصة",
        "خدمة خادم شخصي يتذكر تفضيلات الضيف عبر الزيارات",
        "خطوات من بوتيكات ومعارض ماونت ستريت الفنية",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "اطلب غرفة تواجه الغرب فوق الطابق 40 لإطلالات الغروب على المدينة والويست إند. مسبح الإنفينيتي يكون أهدأ قبل الثامنة صباحاً — تعال مبكراً للسباحة شبه الخاصة فوق الغيوم.",
      gccFeatures: [
        "تقليد ضيافة شانغريلا الآسيوي مع حساسية ثقافية",
        "خيارات حلال متاحة في مطعم TING وخدمة الغرف",
        "سجادات صلاة واتجاه القبلة عند الطلب",
        "سوق بورو القريب لطعام الشارع الحلال المتنوع",
        "غرف عائلية بإطلالات بانورامية وأسرّة إضافية متوفرة",
      ],
    ...
    },
    {
      ...
      insiderTip:
        "اطلب جناح بولغاري مع شرفة مطلة على الحديقة — لا يظهر على الموقع الإلكتروني. السينما الخاصة يمكن حجزها بالكامل لعرض خاص لعائلتك مساءً.",
      gccFeatures: [
        "موقع متميز على بعد دقيقتين سيراً من هارودز للتسوق الفاخر",
        "خيارات طعام حلال متاحة عبر خدمة الغرف والمطعم",
        "أجنحة فسيحة مناسبة للعائلات مع خدمة خادم شخصي",
        "سبا بولغاري مع علاجات خاصة للأزواج",
        "سينما خاصة لأمسيات عائلية حصرية",
      ],
    ...
    <div className={`bg-yl-cream ${isRTL ? "font-arabic" : "font-body"}`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="relative pb-14 pt-28 bg-gradient-to-b from-yl-dark-navy to-yl-dark-navy-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-7 text-center">
          <Breadcrumbs
            items={[{ label: isRTL ? "الرئيسية" : "Home", href: "/" }, { label: isRTL ? "فنادق" : "Hotels" }]}
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-7">
          <h2
            className={`text-3xl font-heading font-bold text-yl-charcoal mb-6 text-center ${isRTL ? "font-arabic" : ""}`}
          >
            {locale === "en" ? "London's Finest Hotels for Arab Travellers" : "أفضل فنادق لندن للمسافرين العرب"}
          </h2>
          <div className="space-y-4 font-body text-base text-yl-gray-600 leading-relaxed">
            {locale === "en" ? (
              <>
                <p>
                  London has long been one of the most beloved destinations for Arab travellers, and its luxury hotel
                  scene reflects this deep connection. From the gilded lobbies of Mayfair to the sky-high suites of The
                  Shard, the capital offers an extraordinary range of five-star accommodations that cater specifically
                  to the needs and expectations of guests from the Gulf and wider Arab world. Many of these properties
                  employ Arabic-speaking staff, offer halal room service options, and are located within walking
                  distance of mosques and prayer facilities.
                </p>
                <p>
                  The hotels we have selected represent the very best of London hospitality. Each property has been
                  personally evaluated for its suitability for Arab visitors — considering factors like proximity to
                  halal restaurants in Mayfair and Knightsbridge, the availability of Arabic television channels,
                  family-friendly suite configurations, and concierge teams experienced in arranging services for Gulf
                  visitors. Whether you are visiting for Eid, a summer family holiday, or a shopping trip to Harrods and
                  Selfridges, these hotels deliver an experience that feels both authentically British and genuinely
                  welcoming.
                </p>
                <p>
                  Booking during peak Gulf travel season (June through August and around Eid al-Fitr) requires advance
                  planning, as London&apos;s top hotels fill quickly with visitors from Saudi Arabia, the UAE, Kuwait,
                  and Qatar. We recommend securing your reservation at least six to eight weeks ahead. Several of these
                  hotels also offer dedicated Ramadan packages with suhoor and iftar dining arrangements.
                </p>
              </>
            ) : (
              <>
                <p>
                  لطالما كانت لندن واحدة من أكثر الوجهات المحبوبة للمسافرين العرب، ومشهد الفنادق الفاخرة فيها يعكس هذا
                  الارتباط العميق. من ردهات مايفير المذهبة إلى الأجنحة المرتفعة في ذا شارد، تقدم العاصمة مجموعة
                  استثنائية من أماكن الإقامة ذات الخمس نجوم التي تلبي احتياجات وتوقعات الضيوف القادمين من الخليج والعالم
                  العربي. توظف العديد من هذه الفنادق موظفين يتحدثون العربية، وتقدم خيارات خدمة الغرف الحلال، وتقع على
                  مسافة قريبة من المساجد ومرافق الصلاة.
                </p>
                <p>
                  تمثل الفنادق التي اخترناها أفضل ما في ضيافة لندن. تم تقييم كل فندق شخصياً من حيث ملاءمته للزوار العرب
                  — مع مراعاة عوامل مثل القرب من المطاعم الحلال في مايفير ونايتسبريدج، وتوفر القنوات التلفزيونية
                  العربية، وتصميمات الأجنحة المناسبة للعائلات، وفرق الكونسيرج ذوي الخبرة في ترتيب الخدمات لزوار الخليج.
                  سواء كنت تزور في العيد أو في إجازة صيفية عائلية أو رحلة تسوق إلى هارودز وسيلفريدجز، تقدم هذه الفنادق
                  تجربة بريطانية أصيلة ومرحبة حقاً.
                </p>
                <p>
                  يتطلب الحجز خلال موسم السفر الخليجي (من يونيو إلى أغسطس وحول عيد الفطر) تخطيطاً مسبقاً، حيث تمتلئ أفضل
                  فنادق لندن بسرعة بالزوار من السعودية والإمارات والكويت وقطر. نوصي بتأمين حجزك قبل ستة إلى ثمانية
                  أسابيع على الأقل. تقدم العديد من هذه الفنادق أيضاً باقات رمضان مخصصة مع ترتيبات السحور والإفطار.
                </p>
              </>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-7 py-14">
            ...
            <BrandCardLight key={hotel.id} className="overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-1 mb-2">
                  ...
                  <span className="font-mono text-[11px] text-yl-gray-500 tracking-wider ml-2">
                    {hotel.rating} ({hotel.reviews.toLocaleString()} {t.reviews})
                  </span>
                </div>

                {/* Name & Location */}
                <h3
                  className={`text-xl font-heading font-bold text-yl-charcoal mb-1 line-clamp-1 group-hover:text-yl-red transition-colors duration-300 ease-yl ${isRTL ? "font-arabic" : ""}`}
                >
                  {hotel.name}
                </h3>
                ...
                {/* Description */}
                <p className="font-body text-sm text-yl-gray-500 mb-4 line-clamp-3 leading-relaxed">
                  {hotel.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {hotel.amenities.map((amenity) => (
                    <BrandTag key={amenity} color="neutral">
                      {amenity}
                    </BrandTag>
                  ))}
                </div>
        ...
        {/* Price disclaimer */}
        <p className="font-mono text-[11px] text-yl-gray-500 text-center mt-10 tracking-wider uppercase">
          {t.metaNote}
        </p>
      </div>
      ...
      <section className="py-12 bg-yl-cream">
        <div className="max-w-7xl mx-auto px-7">
          ...
          >
            {locale === "en" ? "Essential Tips for Arab Travellers" : "نصائح أساسية للمسافرين العرب"}
          </h2>
            ...
            {[
              {
                q:
                  locale === "en"
                    ? "Which London hotels offer halal room service?"
                    : "أي فنادق لندن تقدم خدمة غرف حلال؟",
                a:
                  locale === "en"
              ...
              },
              {
                q:
                  locale === "en"
                    ? "Are there luxury hotels near mosques in London?"
                    : "هل توجد فنادق فاخرة قريبة من المساجد في لندن؟",
                a:
                  locale === "en"
              ...
              },
              {
                q:
                  locale === "en"
                    ? "What is the best area to stay for shopping?"
                    : "ما هي أفضل منطقة للإقامة بالقرب من التسوق؟",
                a:
                  locale === "en"
              ...
              },
              {
                q:
                  locale === "en"
                    ? "Do London hotels provide prayer mats and qibla direction?"
                    : "هل توفر فنادق لندن سجادات صلاة واتجاه القبلة؟",
                a:
                  locale === "en"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/experiences" className="block group">
              <BrandCardLight className="p-6 h-full transition-shadow hover:shadow-lg">
                <div className="text-3xl mb-3">🎭</div>
                <h3
                  className={`text-lg font-heading font-bold text-yl-charcoal mb-2 group-hover:text-yl-red transition-colors ${isRTL ? "font-arabic" : ""}`}
                >
