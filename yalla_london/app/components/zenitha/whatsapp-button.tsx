...
interface WhatsAppButtonProps {
  ...
  /** Pre-filled message */
  message?: string;
  /** Yacht name for contextual messaging */
  yachtName?: string;
}

/**
 * Floating WhatsApp button for MENA audience.
...
export function WhatsAppButton({
  ...
  return (
    ...
    >
      ...
      <span
        className="font-heading font-semibold text-sm whitespace-nowrap overflow-hidden transition-all duration-300"
        style={{
