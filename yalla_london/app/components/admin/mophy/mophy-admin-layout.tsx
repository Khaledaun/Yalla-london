...
const navigation = [
  ...
  },
  {
    ...
    items: [
      { label: 'Overview',                  href: '/admin/cockpit/commerce' },
      { label: 'Products',                  href: '/admin/cockpit/commerce?tab=products' },
      { label: 'Niche Goldmine',            href: '/admin/cockpit/commerce?tab=trends' },
      { label: 'Ideation & Validation',     href: '/admin/cockpit/commerce?tab=briefs' },
      { label: 'Branding & Identity',       href: '/admin/cockpit/commerce?tab=branding' },
      { label: 'Design Assistant',          href: '/admin/cockpit/commerce?tab=design' },
      { label: 'Etsy SEO & Listings',       href: '/admin/cockpit/commerce?tab=etsy' },
      { label: 'Marketing Machine',         href: '/admin/cockpit/commerce?tab=campaigns' },
      { label: 'Growth Blueprint',          href: '/admin/cockpit/commerce?tab=growth' },
      { label: 'TrendRun Engine',           href: '/admin/cockpit/commerce?tab=trendrun' },
      { label: 'Sales & Payouts',           href: '/admin/cockpit/commerce/revenue' },
      { label: 'Assets & Links',            href: '/admin/cockpit/commerce?tab=assets' },
      { label: 'Settings',                  href: '/admin/cockpit/commerce?tab=settings' },
