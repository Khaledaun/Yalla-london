...
describe('Enterprise Analytics Service', () => {
  ...
  describe('Metrics Reporting', () => {
    ...
    test('should get content metrics', async () => {
      ...
      const metrics = await analyticsService.getContentMetrics(startDate, endDate);
  ...
  describe('System Performance Recording', () => {
    test('should record system metrics', async () => {
      ...
      await analyticsService.recordSystemMetric('request_count', 100, 'requests', { endpoint: '/api/test' });
  ...
  describe('Privacy Controls', () => {
    ...
    test('should anonymize IPv6 addresses correctly', () => {
      ...
      expect(anonymizeMethod('2001:db8:85a3:8d3:1319:8a2e:370:7348')).toBe('2001:db8:85a3:8d3::');
  ...
  describe('Error Handling', () => {
    test('should handle database errors gracefully', async () => {
      const { prisma } = require('@/lib/db');
      prisma.analyticsEvent.create.mockRejectedValue(new Error('Database error'));
