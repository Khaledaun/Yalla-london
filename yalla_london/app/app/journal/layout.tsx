...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonicalUrl = `${baseUrl}/journal`;

  const title = `The Zenitha Journal — Charter Guides, Sailing Tips & Destination Stories | ${siteName}`;
  const description =
    "Expert charter guides, sailing itineraries, destination deep-dives, and insider tips for Mediterranean, Adriatic, and Aegean yacht holidays. Written by experienced charter specialists.";
