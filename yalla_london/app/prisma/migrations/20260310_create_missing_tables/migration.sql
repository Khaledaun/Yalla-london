...
CREATE INDEX IF NOT EXISTS "cj_offers_validTo_idx" ON "cj_offers"("validTo");
CREATE INDEX IF NOT EXISTS "cj_offers_isPriceDropped_idx" ON "cj_offers"("isPriceDropped");
CREATE INDEX IF NOT EXISTS "cj_offers_isNewArrival_idx" ON "cj_offers"("isNewArrival");
...
CREATE INDEX IF NOT EXISTS "cj_commissions_linkId_idx" ON "cj_commissions"("linkId");
