...
const NEW_TABLE_INDEXES: Record<string, string[]> = {
  ...
  campaigns: [
    ...
    'CREATE INDEX IF NOT EXISTS "campaigns_campaign_type_idx" ON "campaigns"("campaign_type")',
  ...
  campaign_items: [
    ...
    'CREATE INDEX IF NOT EXISTS "campaign_items_target_id_idx" ON "campaign_items"("target_id")',
  ],
  trend_runs: [
    'CREATE INDEX IF NOT EXISTS "trend_runs_site_id_idx" ON "trend_runs"("site_id")',
    'CREATE INDEX IF NOT EXISTS "trend_runs_status_idx" ON "trend_runs"("status")',
  ],
  etsy_listing_drafts: [
    'CREATE INDEX IF NOT EXISTS "etsy_listing_drafts_site_id_idx" ON "etsy_listing_drafts"("site_id")',
    'CREATE INDEX IF NOT EXISTS "etsy_listing_drafts_status_idx" ON "etsy_listing_drafts"("status")',
  ],
  commerce_campaigns: [
    'CREATE INDEX IF NOT EXISTS "commerce_campaigns_site_id_idx" ON "commerce_campaigns"("site_id")',
    'CREATE INDEX IF NOT EXISTS "commerce_campaigns_status_idx" ON "commerce_campaigns"("status")',
  ],
  commerce_alerts: [
    'CREATE INDEX IF NOT EXISTS "commerce_alerts_site_id_idx" ON "commerce_alerts"("site_id")',
    'CREATE INDEX IF NOT EXISTS "commerce_alerts_alert_type_idx" ON "commerce_alerts"("alert_type")',
    'CREATE INDEX IF NOT EXISTS "commerce_alerts_acknowledged_idx" ON "commerce_alerts"("acknowledged")',
  ],
  commerce_orders: [
    'CREATE INDEX IF NOT EXISTS "commerce_orders_site_id_idx" ON "commerce_orders"("site_id")',
    ...
    'CREATE INDEX IF NOT EXISTS "commerce_orders_created_at_idx" ON "commerce_orders"("created_at")',
  ],
  trend_signals: [
...
const FOREIGN_KEYS: { name: string; sql: string }[] = [
  ...
  { name: "campaign_items_campaign_id_fkey", sql: 'ALTER TABLE "campaign_items" ADD CONSTRAINT "campaign_items_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "campaigns"("id") ON DELETE CASCADE ON UPDATE CASCADE' },
  { name: "tenant_integrations_tenant_id_fkey", sql: 'ALTER TABLE "tenant_integrations" ADD CONSTRAINT "tenant_integrations_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE' },
  // Premium FKs
